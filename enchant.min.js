...
a);var e=d.getResponseHeader("Content-Type")||"";e.match(/^image/)?(c.assets[a]=enchant.Surface.load(a),c.assets[a].addEventListener("load",b)):e.match(/^audio/)?(c.assets[a]=enchant.Sound.load(a,e),c.assets[a].addEventListener("load",b)):(c.assets[asset]=d.responseText,b())}};d.send(null)}},start:function(){if(this._intervalID)window.clearInterval(this._intervalID);else if(this._assets.length){if(!c._touched){var a=new Scene;a.backgroundColor="#000";var b=Math.round(c.width/10),e=new Sprite(c.width,
b);e.y=(c.height-b)/2;e.image=new Surface(c.width,b);e.image.context.fillStyle="#fff";e.image.context.font=b-1+"px bold Helvetica,Arial,sans-serif";var d=e.image.context.measureText("Touch to Start").width;e.image.context.fillText("Touch to Start",(c.width-d)/2,b-1);a.addChild(e);document.addEventListener("touchstart",function(){c._touched=!0;c.removeScene(a);c.start()},!0);c.pushScene(a);return}var m={},b=this._assets.filter(function(a){return a in m?!1:m[a]=!0}),h=0,e=0,i=b.length;for(;e<i;e++)this.load(b[e],
...
a=this;l?(this._element.addEventListener("touchstart",function(b){for(var d=b.touches,c=0,h=d.length;c<h;c++)b=new enchant.Event("touchstart"),b.identifier=d[c].identifier,b._initPosition(d[c].pageX,d[c].pageY),a.dispatchEvent(b)},!1),this._element.addEventListener("touchmove",function(b){for(var d=b.touches,c=0,h=d.length;c<h;c++)b=new enchant.Event("touchmove"),b.identifier=d[c].identifier,b._initPosition(d[c].pageX,d[c].pageY),a.dispatchEvent(b)},!1),this._element.addEventListener("touchend",function(b){for(var d=
b.changedTouches,c=0,h=d.length;c<h;c++)b=new enchant.Event("touchend"),b.identifier=d[c].identifier,b._initPosition(d[c].pageX,d[c].pageY),a.dispatchEvent(b)},!1)):(this._element.addEventListener("mousedown",function(b){var d=b.pageX,m=b.pageY,b=new enchant.Event("touchstart");b.identifier=c._mousedownID;b._initPosition(d,m);a.dispatchEvent(b);a._mousedown=!0},!1),c._element.addEventListener("mousemove",function(b){if(a._mousedown){var d=b.pageX,m=b.pageY,b=new enchant.Event("touchmove");b.identifier=
c._mousedownID;b._initPosition(d,m);a.dispatchEvent(b)}},!1),c._element.addEventListener("mouseup",function(b){if(a._mousedown){var d=b.pageX,m=b.pageY,b=new enchant.Event("touchend");b.identifier=c._mousedownID;b._initPosition(d,m);a.dispatchEvent(b);a._mousedown=!1}},!1))},width:{get:function(){return this._width},set:function(a){this._style.width=(this._width=a)+"px"}},height:{get:function(){return this._height},set:function(a){this._style.height=(this._height=a)+"px"}},backgroundColor:{get:function(){return this._backgroundColor},
...
function(){if(this._dirty)this._style[g+"Transform"]=["rotate(",this._rotation,"deg)scale(",this._scaleX,",",this._scaleY,")"].join(""),this._dirty=!1})},image:{get:function(){return this._image},set:function(a){if(a!=this._image){if(this._image!=null)if(this._image.css)this._style.backgroundImage="";else if(this._element.firstChild)this._element.removeChild(this._element.firstChild),this._dirtyListener?(this.removeEventListener("render",this._dirtyListener),this._dirtyListener=null):this._image._parent=
...
b||0;this._image=null;this._data=[[[]]];this.touchEnabled=this._tight=this._dirty=!1;this.collisionData=null;this._listeners.render=null;this.addEventListener("render",function(){if(this._dirty||this._previousOffsetX==null)this._dirty=!1,this.redraw(0,0,c.width,c.height);else if(this._offsetX!=this._previousOffsetX||this._offsetY!=this._previousOffsetY)if(this._tight){var a=-this._offsetX,b=-this._offsetY,e=-this._previousOffsetX,i=-this._previousOffsetY,g=a-e+c.width,k=e-a+c.width,j=b-i+c.height,
f=i-b+c.height;if(g>this._tileWidth&&k>this._tileWidth&&j>this._tileHeight&&f>this._tileHeight){var l;g<k?(l=0,a=e-a,k=g):(l=a-e,a=0);j<f?(g=0,b=i-b):(g=b-i,b=0,j=f);if(c._buffer==null)c._buffer=document.createElement("canvas"),c._buffer.width=this._context.canvas.width,c._buffer.height=this._context.canvas.height;f=c._buffer.getContext("2d");this._doubledImage?(f.clearRect(0,0,k*2,j*2),f.drawImage(this._context.canvas,l*2,g*2,k*2,j*2,0,0,k*2,j*2),f=this._context,f.clearRect(a*2,b*2,k*2,j*2),f.drawImage(c._buffer,
0,0,k*2,j*2,a*2,b*2,k*2,j*2)):(f.clearRect(0,0,k,j),f.drawImage(this._context.canvas,l,g,k,j,0,0,k,j),f=this._context,f.clearRect(a,b,k,j),f.drawImage(c._buffer,0,0,k,j,a,b,k,j));a==0?this.redraw(k,0,c.width-k,c.height):this.redraw(0,0,c.width-k,c.height);b==0?this.redraw(0,j,c.width,c.height-j):this.redraw(0,0,c.width,c.height-j)}else this.redraw(0,0,c.width,c.height)}else this.redraw(0,0,c.width,c.height);this._previousOffsetX=this._offsetX;this._previousOffsetY=this._offsetY})},loadData:function(a){this._data=
Array.prototype.slice.apply(arguments);this._dirty=!0;this._tight=!1;for(var b=0,e=this._data.length;b<e;b++){for(var d=0,a=this._data[b],c=0,h=a.length;c<h;c++)for(var i=0,g=a[c].length;i<g;i++)a[c][i]>=0&&d++;if(d/(a.length*a[0].length)>0.2){this._tight=!0;break}}},hitTest:function(a,b){if(a<0||this.width<=a||b<0||this.height<=b)return!1;var e=this._image.width,d=this._image.height,c=this._tileWidth||e,h=this._tileHeight||d,a=a/c|0,b=b/h|0;if(this.collisionData!=null)return this.collisionData[b]&&
!!this.collisionData[b][a];else{for(var i=0,g=this._data.length;i<g;i++){var f=this._data[i],j;if(f[b]!=null&&(j=f[b][a])!=null&&0<=j&&j<(e/c|0)*(d/h|0))return!0}return!1}},image:{get:function(){return this._image},set:function(a){this._image=a;if(f&&c.scale==2){for(var b=new Surface(a.width*2,a.height*2),e=this._tileWidth||a.width,d=this._tileHeight||a.height,m=a.width/e|0,h=a.height/d|0,i=0;i<h;i++)for(var g=0;g<m;g++)b.draw(a,g*e,i*d,e,d,g*e*2,i*d*2,e*2,d*2);this._doubledImage=b}this._dirty=!0}},
tileWidth:{get:function(){return this._tileWidth},set:function(a){this._tileWidth=a;this._dirty=!0}},tileHeight:{get:function(){return this._tileHeight},set:function(a){this._tileHeight=a;this._dirty=!0}},width:{get:function(){return this._tileWidth*this._data[0][0].length}},height:{get:function(){return this._tileHeight*this._data[0].length}},redraw:function(a,b,e,d){if(this._image!=null){var c,h,i,g,f;this._doubledImage?(c=this._doubledImage,h=this._tileWidth*2,i=this._tileHeight*2,g=-this._offsetX*
2,f=-this._offsetY*2,a*=2,b*=2,e*=2,d*=2):(c=this._image,h=this._tileWidth,i=this._tileHeight,g=-this._offsetX,f=-this._offsetY);var j=c.width/h|0,l=c.height/i|0,n=Math.max((a+g)/h|0,0),t=Math.max((b+f)/i|0,0),u=Math.ceil((a+g+e)/h),q=Math.ceil((b+f+d)/i);c=c._element;var s=this._context;s.clearRect(a,b,e,d);e=0;for(d=this._data.length;e<d;e++)for(var r=this._data[e],v=Math.min(u,r[0].length),w=Math.min(q,r.length),b=t;b<w;b++)for(a=n;a<v;a++){var p=r[b][a];0<=p&&p<j*l&&s.drawImage(c,p%j*h,(p/j|0)*
i,h,i,a*h-g,b*i-f,h,i)}}}});enchant.Group=enchant.Class.create(enchant.Node,{initialize:function(){enchant.Node.call(this);this.childNodes=[];this._y=this._x=0},addChild:function(a){this.childNodes.push(a);a.parentNode=this;a.dispatchEvent(new enchant.Event("added"));if(this.scene){var b=new enchant.Event("addedtoscene");a.scene=this.scene;a.dispatchEvent(b);a._updateCoordinate();var e=document.createDocumentFragment(),d,c=Array.prototype.push;if(a._element)e.appendChild(a._element);else if(a.childNodes)for(d=
