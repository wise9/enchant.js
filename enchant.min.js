...
b.src=a;b.onerror=function(){throw Error("Cannot load an asset: "+b.src);};b.onload=function(){c.width=b.width;c.height=b.height;c.dispatchEvent(new enchant.Event("load"))};return c};enchant.Sound=enchant.Class.create(enchant.EventTarget,{initialize:function(){enchant.EventTarget.call(this);throw Error("Illegal Constructor");},play:function(){this._element&&this._element.play()},pause:function(){this._element&&this._element.pause()},stop:function(){this.pause();this.currentTime=0},clone:function(){var a;
a=this._element instanceof Audio?Object.create(enchant.Sound.prototype,{_element:{value:this._element.cloneNode(!1)},duration:{value:this.duration}}):Object.create(enchant.Sound.prototype);enchant.EventTarget.call(a);return a},currentTime:{get:function(){return this._element?this._element.currentTime:0},set:function(a){if(this._element)this._element.currentTime=a}},volume:{get:function(){return this._element?this._element.volume:1},set:function(a){if(this._element)this._element.volume=a}}});enchant.Sound.load=
function(a,b){if(b==null)var e=a.match(/\.\w+$/)[0],b=e?"audio/"+e.slice(1).toLowerCase():"";var d=Object.create(enchant.Sound.prototype);enchant.EventTarget.call(d);var f=new Audio;if(!enchant.Sound.enabledInMobileSafari&&g=="webkit"&&l)window.setTimeout(function(){d.dispatchEvent(new enchant.Event("load"))},0);else if(f.canPlayType(b))f.src=a,f.load(),f.autoplay=!1,f.onerror=function(){throw Error("Cannot load an asset: "+f.src);},f.addEventListener("canplaythrough",function(){d.duration=f.duration;
d.dispatchEvent(new enchant.Event("load"))},!1),d._element=f;else if(b.match(/^audio\/(mpeg|mp3)/)){var h=document.createElement("embed"),e="enchant-audio"+c._soundID++;h.width=h.height=1;h.name=e;h.src="sound.swf?id=&src="+a;h.allowscriptaccess="always";h.style.position="absolute";h.style.left="-1px";d.addEventListener("load",function(){Object.defineProperties(h,{currentTime:{get:function(){return h.getCurrentTime()},set:function(a){h.setCurrentTime(a)}},volume:{get:function(){return h.getVolume()},
set:function(a){h.setVolume(a)}}});d._element=h;d.duration=h.getDuration()});c._element.appendChild(h);enchant.Sound[e]=d}else window.setTimeout(function(){d.dispatchEvent(new enchant.Event("load"))},0);return d};enchant.Sound.enabledInMobileSafari=!1})();
