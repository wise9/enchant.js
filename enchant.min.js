...
(this._visible=a)?"block":"none"}},touchEnabled:{get:function(){return this._touchEnabled},set:function(a){this._style.pointerEvents=(this._touchEnabled=a)?"all":"none"}},intersect:function(a){return this.x<a.x+a.width&&a.x<this.x+this.width&&this.y<a.y+a.height&&a.y<this.y+this.height},within:function(a,b){b==null&&(b=(this.width+this.height+a.width+a.height)/4);var d;return(d=this.x-a.x+(this.width-a.width)/2)*d+(d=this.y-a.y+(this.height-a.height)/2)*d<b*b},scale:function(a,b){b==null&&(b=a);this._scaleX=
...
this.width=a;this.height=b;this._scaleY=this._scaleX=1;this._rotation=0;this._dirty=false;this._image=null;this._frame=0;this._frameSequence=[];this._style.overflow="hidden";this.addEventListener("render",function(){if(this._dirty){this._style[enchant.ENV.VENDOR_PREFIX+"Transform"]=["rotate(",this._rotation,"deg)scale(",this._scaleX,",",this._scaleY,")"].join("");this._dirty=false}});this.addEventListener("enterframe",function(){if(this._frameSequence.length!==0){var a=this._frameSequence.shift();
...
else if(this._element.firstChild){var d=this._element.firstChild.style;d.left=-(a%b|0)*this._width+"px";d.top=-(a/b|0)*this._height+"px"}}}});enchant.Label=enchant.Class.create(enchant.Entity,{initialize:function(a){enchant.Entity.call(this);this.width=300;this.text=a;this.textAlign="left"},text:{get:function(){return this._element.innerHTML},set:function(a){this._element.innerHTML=a}},textAlign:{get:function(){return this._style.textAlign},set:function(a){this._style.textAlign=a}},font:{get:function(){return this._style.font},
...
d.getContext("2d");this._tileWidth=a||0;this._tileHeight=b||0;this._image=null;this._data=[[[]]];this.touchEnabled=this._tight=this._dirty=false;this.collisionData=null;this._listeners.render=null;this.addEventListener("render",function(){if(this._dirty||this._previousOffsetX==null){this._dirty=false;this.redraw(0,0,e.width,e.height)}else if(this._offsetX!=this._previousOffsetX||this._offsetY!=this._previousOffsetY)if(this._tight){var a=-this._offsetX,b=-this._offsetY,d=-this._previousOffsetX,k=-this._previousOffsetY,
q=a-d+e.width,i=d-a+e.width,j=b-k+e.height,f=k-b+e.height;if(q>this._tileWidth&&i>this._tileWidth&&j>this._tileHeight&&f>this._tileHeight){var h;if(q<i){h=0;a=d-a;i=q}else{h=a-d;a=0}if(j<f){q=0;b=k-b}else{q=b-k;b=0;j=f}if(e._buffer==null){e._buffer=document.createElement("canvas");e._buffer.width=this._context.canvas.width;e._buffer.height=this._context.canvas.height}f=e._buffer.getContext("2d");if(this._doubledImage){f.clearRect(0,0,i*2,j*2);f.drawImage(this._context.canvas,h*2,q*2,i*2,j*2,0,0,i*
2,j*2);f=this._context;f.clearRect(a*2,b*2,i*2,j*2);f.drawImage(e._buffer,0,0,i*2,j*2,a*2,b*2,i*2,j*2)}else{f.clearRect(0,0,i,j);f.drawImage(this._context.canvas,h,q,i,j,0,0,i,j);f=this._context;f.clearRect(a,b,i,j);f.drawImage(e._buffer,0,0,i,j,a,b,i,j)}a==0?this.redraw(i,0,e.width-i,e.height):this.redraw(0,0,e.width-i,e.height);b==0?this.redraw(0,j,e.width,e.height-j):this.redraw(0,0,e.width,e.height-j)}else this.redraw(0,0,e.width,e.height)}else this.redraw(0,0,e.width,e.height);this._previousOffsetX=
this._offsetX;this._previousOffsetY=this._offsetY})},loadData:function(a){this._data=Array.prototype.slice.apply(arguments);this._dirty=true;this._tight=false;for(var b=0,d=this._data.length;b<d;b++){for(var c=0,a=this._data[b],g=0,n=a.length;g<n;g++)for(var e=0,f=a[g].length;e<f;e++)a[g][e]>=0&&c++;if(c/(a.length*a[0].length)>0.2){this._tight=true;break}}},checkTile:function(a,b){if(a<0||this.width<=a||b<0||this.height<=b)return false;var d=this._image.width,c=this._image.height,c=this._tileHeight||
c,a=a/(this._tileWidth||d)|0;return this._data[0][b/c|0][a]},hitTest:function(a,b){if(a<0||this.width<=a||b<0||this.height<=b)return false;var d=this._image.width,c=this._image.height,g=this._tileWidth||d,e=this._tileHeight||c,a=a/g|0,b=b/e|0;if(this.collisionData!=null)return this.collisionData[b]&&!!this.collisionData[b][a];for(var k=0,f=this._data.length;k<f;k++){var i=this._data[k],j;if(i[b]!=null&&(j=i[b][a])!=null&&0<=j&&j<(d/g|0)*(c/e|0))return true}return false},image:{get:function(){return this._image},
set:function(a){this._image=a;if(enchant.ENV.RETINA_DISPLAY&&e.scale==2){for(var b=new enchant.Surface(a.width*2,a.height*2),d=this._tileWidth||a.width,c=this._tileHeight||a.height,g=a.width/d|0,n=a.height/c|0,k=0;k<n;k++)for(var f=0;f<g;f++)b.draw(a,f*d,k*c,d,c,f*d*2,k*c*2,d*2,c*2);this._doubledImage=b}this._dirty=true}},tileWidth:{get:function(){return this._tileWidth},set:function(a){this._tileWidth=a;this._dirty=true}},tileHeight:{get:function(){return this._tileHeight},set:function(a){this._tileHeight=
a;this._dirty=true}},width:{get:function(){return this._tileWidth*this._data[0][0].length}},height:{get:function(){return this._tileHeight*this._data[0].length}},redraw:function(a,b,d,c){if(this._image!=null){var g,e,k,f,i;if(this._doubledImage){g=this._doubledImage;e=this._tileWidth*2;k=this._tileHeight*2;f=-this._offsetX*2;i=-this._offsetY*2;a=a*2;b=b*2;d=d*2;c=c*2}else{g=this._image;e=this._tileWidth;k=this._tileHeight;f=-this._offsetX;i=-this._offsetY}var j=g.width/e|0,h=g.height/k|0,l=Math.max((a+
f)/e|0,0),m=Math.max((b+i)/k|0,0),o=Math.ceil((a+f+d)/e),p=Math.ceil((b+i+c)/k);g=g._element;var r=this._context;r.clearRect(a,b,d,c);d=0;for(c=this._data.length;d<c;d++)for(var s=this._data[d],t=Math.min(o,s[0].length),u=Math.min(p,s.length),b=m;b<u;b++)for(a=l;a<t;a++){var v=s[b][a];0<=v&&v<j*h&&r.drawImage(g,v%j*e,(v/j|0)*k,e,k,a*e-f,b*k-i,e,k)}}}});enchant.Group=enchant.Class.create(enchant.Node,{initialize:function(){enchant.Node.call(this);this.childNodes=[];this._y=this._x=0},addChild:function(a){this.childNodes.push(a);
a.parentNode=this;a.dispatchEvent(new enchant.Event("added"));if(this.scene){var b=new enchant.Event("addedtoscene");a.scene=this.scene;a.dispatchEvent(b);a._updateCoordinate();var d=document.createDocumentFragment(),c,g=Array.prototype.push;if(a._element)d.appendChild(a._element);else if(a.childNodes)for(c=a.childNodes.slice().reverse();c.length;){a=c.pop();a.scene=this.scene;a.dispatchEvent(b);a._element?d.appendChild(a._element):a.childNodes&&g.apply(c,a.childNodes.reverse())}if(d.childNodes.length){for(var e,
b=this;b.parentNode;){c=b.parentNode.childNodes;for(c=c.slice(c.indexOf(b)+1).reverse();c.length;){a=c.pop();if(a._element){e=a._element;break}else a.childNodes&&g.apply(c,a.childNodes.slice().reverse())}b=b.parentNode}e?this.scene._element.insertBefore(d,e):this.scene._element.appendChild(d)}}},insertBefore:function(a,b){var d=this.childNodes.indexOf(b);if(d!=-1){this.childNodes.splice(d,0,a);a.parentNode=this;a.dispatchEvent(new enchant.Event("added"));if(this.scene){var c=new enchant.Event("addedtoscene");
a.scene=this.scene;a.dispatchEvent(c);a._updateCoordinate();var g=document.createDocumentFragment(),e,f=Array.prototype.push;if(a._element)g.appendChild(a._element);else if(a.childNodes)for(e=a.childNodes.slice().reverse();e.length;){a=e.pop();a.scene=this.scene;a.dispatchEvent(c);a._element?g.appendChild(a._element):a.childNodes&&f.apply(e,a.childNodes.reverse())}if(g.childNodes.length){for(var h,c=b;c!=this;){if(d!=null){e=this.childNodes.slice(d+1).reverse();d=null}else{e=c.parentNode.childNodes;
e=e.slice(e.indexOf(c)+1).reverse()}for(;e.length;){a=e.pop();if(a._element){h=a._element;break}else a.childNodes&&f.apply(e,a.childNodes.slice().reverse())}c=c.parentNode}h?this.scene._element.insertBefore(g,h):this.scene._element.appendChild(g)}}}else this.addChild(a)},removeChild:function(a){var b=this.childNodes.indexOf(a);if(b!=-1){this.childNodes.splice(b,1);a.parentNode=null;a.dispatchEvent(new enchant.Event("removed"));if(this.scene){b=new enchant.Event("removedfromscene");a.scene=null;a.dispatchEvent(b);
if(a._element)this.scene._element.removeChild(a._element);else if(a.childNodes)for(var d=a.childNodes.slice(),c=Array.prototype.push;d.length;){a=d.pop();a.scene=null;a.dispatchEvent(b);a._element?this.scene._element.removeChild(a._element):a.childNodes&&c.apply(d,a.childNodes)}}}},firstChild:{get:function(){return this.childNodes[0]}},lastChild:{get:function(){return this.childNodes[this.childNodes.length-1]}},_updateCoordinate:function(){if(this.parentNode){this._offsetX=this.parentNode._offsetX+
...
arguments);a.transformOrigin="0 0"},rotation:{get:function(){return this._rotation},set:function(a){var b=a-this._rotation;if(b!=0){for(var d=b/180*Math.PI,c=Math.sin(d),d=Math.cos(d),e=this.width/2,n=this.height/2,f=0,h=this.childNodes.length;f<h;f++){var i=this.childNodes[f];i.rotation=i.rotation-b;var j=i.x-e,l=i.y-n;i.x=+d*j+c*l+e;i.y=-c*j+d*l+n}this._rotation=a}}}});enchant.Scene=enchant.Class.create(enchant.Group,{initialize:function(){enchant.Group.call(this);this._element=document.createElement("div");
this._element.style.position="absolute";this._element.style.overflow="hidden";this._element.style.width=(this.width=e.width)+"px";this._element.style.height=(this.height=e.height)+"px";this._element.style[enchant.ENV.VENDOR_PREFIX+"TransformOrigin"]="0 0";this._element.style[enchant.ENV.VENDOR_PREFIX+"Transform"]="scale("+e.scale+")";this.scene=this;var a=this;if(enchant.ENV.TOUCH_ENABLED){this._element.addEventListener("touchstart",function(b){for(var d=b.touches,c=0,e=d.length;c<e;c++){b=new enchant.Event("touchstart");
b.identifier=d[c].identifier;b._initPosition(d[c].pageX,d[c].pageY);a.dispatchEvent(b)}},false);this._element.addEventListener("touchmove",function(b){for(var d=b.touches,c=0,e=d.length;c<e;c++){b=new enchant.Event("touchmove");b.identifier=d[c].identifier;b._initPosition(d[c].pageX,d[c].pageY);a.dispatchEvent(b)}},false);this._element.addEventListener("touchend",function(b){for(var d=b.changedTouches,c=0,e=d.length;c<e;c++){b=new enchant.Event("touchend");b.identifier=d[c].identifier;b._initPosition(d[c].pageX,
d[c].pageY);a.dispatchEvent(b)}},false)}else{this._element.addEventListener("mousedown",function(b){var d=b.pageX,c=b.pageY,b=new enchant.Event("touchstart");b.identifier=e._mousedownID;b._initPosition(d,c);a.dispatchEvent(b);a._mousedown=true},false);e._element.addEventListener("mousemove",function(b){if(a._mousedown){var d=b.pageX,c=b.pageY,b=new enchant.Event("touchmove");b.identifier=e._mousedownID;b._initPosition(d,c);a.dispatchEvent(b)}},false);e._element.addEventListener("mouseup",function(b){if(a._mousedown){var d=
b.pageX,c=b.pageY,b=new enchant.Event("touchend");b.identifier=e._mousedownID;b._initPosition(d,c);a.dispatchEvent(b);a._mousedown=false}},false)}},backgroundColor:{get:function(){return this._backgroundColor},set:function(a){this._element.style.backgroundColor=this._backgroundColor=a}},_updateCoordinate:function(){this._offsetX=this._x;this._offsetY=this._y;for(var a=0,b=this.childNodes.length;a<b;a++)this.childNodes[a]._updateCoordinate()}});var E=["putImageData","drawImage","drawFocusRing","fill",
"stroke","clearRect","fillRect","strokeRect","fillText","strokeText"];enchant.Surface=enchant.Class.create(enchant.EventTarget,{initialize:function(a,b){enchant.EventTarget.call(this);this.width=a;this.height=b;this.context=null;var d="enchant-surface"+e._surfaceID++;if(document.getCSSCanvasContext){this.context=document.getCSSCanvasContext("2d",d,a,b);this._element=this.context.canvas;this._css="-webkit-canvas("+d+")"}else if(document.mozSetImageElement){this._element=document.createElement("canvas");
...
>>>>>>> c686bba346f3f3849e2fdea3bc451bd37f2f97ee
