...
(e.width-c)/2,b-1);a.addChild(d);document.addEventListener("touchstart",function(){e._touched=true;e.removeScene(a);e.start()},true);e.pushScene(a);return}var n={},b=this._assets.filter(function(a){return a in n?false:n[a]=true}),g=0,d=0,i=b.length;for(;d<i;d++)this.load(b[d],function(){var a=new enchant.Event("progress");a.loaded=++g;a.total=i;e.dispatchEvent(a);if(g==i){e.removeScene(e.loadingScene);e.dispatchEvent(new enchant.Event("load"))}});this.pushScene(this.loadingScene)}else this.dispatchEvent(new enchant.Event("load"));
...
{initialize:function(){enchant.EventTarget.call(this);this.age=this._offsetY=this._offsetX=this._y=this._x=0;this.scene=this.parentNode=null;this.addEventListener("touchstart",function(a){this.parentNode&&this.parentNode!=this.scene&&this.parentNode.dispatchEvent(a)});this.addEventListener("touchmove",function(a){this.parentNode&&this.parentNode!=this.scene&&this.parentNode.dispatchEvent(a)});this.addEventListener("touchend",function(a){this.parentNode&&this.parentNode!=this.scene&&this.parentNode.dispatchEvent(a)})},
...
function(b){for(var c=b.touches,e=0,g=c.length;e<g;e++){b=new enchant.Event("touchstart");b.identifier=c[e].identifier;b._initPosition(c[e].pageX,c[e].pageY);a.dispatchEvent(b)}},false);this._element.addEventListener("touchmove",function(b){for(var c=b.touches,e=0,g=c.length;e<g;e++){b=new enchant.Event("touchmove");b.identifier=c[e].identifier;b._initPosition(c[e].pageX,c[e].pageY);a.dispatchEvent(b)}},false);this._element.addEventListener("touchend",function(b){for(var c=b.changedTouches,e=0,g=
c.length;e<g;e++){b=new enchant.Event("touchend");b.identifier=c[e].identifier;b._initPosition(c[e].pageX,c[e].pageY);a.dispatchEvent(b)}},false)}else{this._element.addEventListener("mousedown",function(b){var c=b.pageX,n=b.pageY,b=new enchant.Event("touchstart");b.identifier=e._mousedownID;b._initPosition(c,n);a.dispatchEvent(b);a._mousedown=true},false);e._element.addEventListener("mousemove",function(b){if(a._mousedown){var c=b.pageX,n=b.pageY,b=new enchant.Event("touchmove");b.identifier=e._mousedownID;
b._initPosition(c,n);a.dispatchEvent(b)}},false);e._element.addEventListener("mouseup",function(b){if(a._mousedown){var c=b.pageX,n=b.pageY,b=new enchant.Event("touchend");b.identifier=e._mousedownID;b._initPosition(c,n);a.dispatchEvent(b);a._mousedown=false}},false)}},id:{get:function(){return this._element.id},set:function(a){this._element.id=a}},className:{get:function(){return this._element.className},set:function(a){this._element.className=a}},width:{get:function(){return this._width},set:function(a){this._style.width=
