...
*/
if("function"!=typeof Object.defineProperty)Object.defineProperty=function(f,m,g){if("value"in g)f[m]=g.value;"get"in g&&f.__defineGetter__(m,g.get);"set"in g&&f.__defineSetter__(m,g.set);return f};if("function"!=typeof Object.defineProperties)Object.defineProperties=function(f,m){for(var g in m)m.hasOwnProperty(g)&&Object.defineProperty(f,g,m[g]);return f};
if("function"!=typeof Object.create)Object.create=function(f,m){function g(){}g.prototype=f;var e=new g;null!=m&&Object.defineProperties(e,m);return e};if("function"!=typeof Object.getPrototypeOf)Object.getPrototypeOf=function(f){return f.__proto__};
var enchant=function(f){null!=f&&(f instanceof Array||(f=Array.prototype.slice.call(arguments)),f=f.filter(function(f){return""+f}));(function g(e,n){var a=[],b;for(b in e)e.hasOwnProperty(b)&&("function"==typeof e[b]?window[b]=e[b]:Object.getPrototypeOf(e[b])==Object.prototype&&(null==f?a.push(b):(c=f.indexOf(n+b),-1!=c&&(a.push(b),f.splice(c,1)))));var c=0;for(b=a.length;c<b;c++)g(e[a[c]],n+a[c]+".")})(enchant,"");if(null!=f&&f.length)throw Error("Cannot load module: "+f.join(", "));};
(function(){var f=function(){var a=navigator.userAgent;return-1!=a.indexOf("Opera")?"O":-1!=a.indexOf("MSIE")?"ms":-1!=a.indexOf("WebKit")?"webkit":"Gecko"==navigator.product?"Moz":""}(),m=function(){var a=document.createElement("div");a.setAttribute("ontouchstart","return");return"function"==typeof a.ontouchstart}(),g=function(){if(-1!=navigator.userAgent.indexOf("iPhone")&&2==window.devicePixelRatio){var a=document.querySelector('meta[name="viewport"]');null==a&&(a=document.createElement("meta"),
...
if(d){var h=window.getComputedStyle(d),a=parseInt(h.width),b=parseInt(h.height);a&&b?this.scale=Math.min(a/this.width,b/this.height):(d.style.width=this.width+"px",d.style.height=this.height+"px");for(;d.firstChild;)d.removeChild(d.firstChild);d.style.position="relative";h=d.getBoundingClientRect();isNaN(window.scrollX);isNaN(window.scrollY);this._pageX=Math.round(window.scrollX+h.left);this._pageY=Math.round(window.scrollY+h.top)}else d=document.createElement("div"),d.id="enchant-stage",d.style.width=
window.innerWidth+"px",d.style.height=window.innerHeight+"px",d.style.position="absolute",document.body.firstChild?document.body.insertBefore(d,document.body.firstChild):document.body.appendChild(d),this.scale=Math.min(window.innerWidth/this.width,window.innerHeight/this.height),this._pageY=this._pageX=0;if(!this.scale)this.scale=1;d.style.fontSize="12px";d.style.webkitTextSizeAdjust="none";this._element=d;this.fps=30;this.frame=0;this.ready=null;this.running=!1;this.assets={};var j=this._assets=
[];(function q(a){a.assets instanceof Array&&[].push.apply(j,a.assets);for(var b in a)a.hasOwnProperty(b)&&Object.getPrototypeOf(a[b])==Object.prototype&&q(a[b])})(enchant);this._scenes=[];this.currentScene=null;this.rootScene=new enchant.Scene;this.pushScene(this.rootScene);this.loadingScene=new enchant.Scene;this.loadingScene.backgroundColor="#000";var i=0.9*this.width|0,o=0.3*this.width|0,l=0.05*i|0,d=new enchant.Sprite(i,o);d.x=(this.width-i)/2;d.y=(this.height-o)/2;var k=new enchant.Surface(i,
o);k.context.fillStyle="#fff";k.context.fillRect(0,0,i,o);k.context.fillStyle="#000";k.context.fillRect(l,l,i-2*l,o-2*l);d.image=k;var f=0,g=0;this.addEventListener("progress",function(a){f=a.loaded/a.total});d.addEventListener("enterframe",function(){g*=0.9;g+=0.1*f;k.context.fillStyle="#fff";k.context.fillRect(l,0,(i-2*l)*g,o)});this.loadingScene.addChild(d);this._soundID=this._surfaceID=this._mousedownID=0;this._intervalID=null;this.input={};this._keybind={};this.keybind(37,"left");this.keybind(38,
...
c&&(document.addEventListener("keydown",function(a){e.dispatchEvent(new enchant.Event("keydown"));if(37<=a.keyCode&&40>=a.keyCode||32==a.keyCode)a.preventDefault(),a.stopPropagation();if(e.running&&(a=e._keybind[a.keyCode]))a=new enchant.Event(a+"buttondown"),e.dispatchEvent(a)},!0),document.addEventListener("keyup",function(a){if(e.running&&(a=e._keybind[a.keyCode]))a=new enchant.Event(a+"buttonup"),e.dispatchEvent(a)},!0),m?(document.addEventListener("touchstart",function(a){a.preventDefault()},
...
this._offsetY+"px";this._previousOffsetX=this._offsetX;this._previousOffsetY=this._offsetY});a=this;m?(this._element.addEventListener("touchstart",function(b){for(var d=b.touches,h=0,e=d.length;h<e;h++)b=new enchant.Event("touchstart"),b.identifier=d[h].identifier,b._initPosition(d[h].pageX,d[h].pageY),a.dispatchEvent(b)},!1),this._element.addEventListener("touchmove",function(b){for(var d=b.touches,h=0,e=d.length;h<e;h++)b=new enchant.Event("touchmove"),b.identifier=d[h].identifier,b._initPosition(d[h].pageX,
d[h].pageY),a.dispatchEvent(b)},!1),this._element.addEventListener("touchend",function(b){for(var d=b.changedTouches,h=0,e=d.length;h<e;h++)b=new enchant.Event("touchend"),b.identifier=d[h].identifier,b._initPosition(d[h].pageX,d[h].pageY),a.dispatchEvent(b)},!1)):(this._element.addEventListener("mousedown",function(b){var d=b.pageX,h=b.pageY,b=new enchant.Event("touchstart");b.identifier=e._mousedownID;b._initPosition(d,h);a.dispatchEvent(b);a._mousedown=!0},!1),e._element.addEventListener("mousemove",
function(b){if(a._mousedown){var d=b.pageX,h=b.pageY,b=new enchant.Event("touchmove");b.identifier=e._mousedownID;b._initPosition(d,h);a.dispatchEvent(b)}},!1),e._element.addEventListener("mouseup",function(b){if(a._mousedown){var d=b.pageX,h=b.pageY,b=new enchant.Event("touchend");b.identifier=e._mousedownID;b._initPosition(d,h);a.dispatchEvent(b);a._mousedown=!1}},!1))},id:{get:function(){return this._element.id},set:function(a){this._element.id=a}},className:{get:function(){return this._element.className},
...
enchant.Class.create(enchant.Entity,{initialize:function(a,b){enchant.Entity.call(this);var c=document.createElement("canvas");g&&2==e.scale?(c.width=2*e.width,c.height=2*e.height,this._style.webkitTransformOrigin="0 0",this._style.webkitTransform="scale(0.5)"):(c.width=e.width,c.height=e.height);this._element.appendChild(c);this._context=c.getContext("2d");this._tileWidth=a||0;this._tileHeight=b||0;this._image=null;this._data=[[[]]];this.touchEnabled=this._tight=this._dirty=!1;this.collisionData=
null;this._listeners.render=null;this.addEventListener("render",function(){if(this._dirty||null==this._previousOffsetX)this._dirty=!1,this.redraw(0,0,e.width,e.height);else if(this._offsetX!=this._previousOffsetX||this._offsetY!=this._previousOffsetY)if(this._tight){var a=-this._offsetX,b=-this._offsetY,c=-this._previousOffsetX,i=-this._previousOffsetY,f=a-c+e.width,l=c-a+e.width,k=b-i+e.height,g=i-b+e.height;if(f>this._tileWidth&&l>this._tileWidth&&k>this._tileHeight&&g>this._tileHeight){var m;f<
l?(m=0,a=c-a,l=f):(m=a-c,a=0);k<g?(f=0,b=i-b):(f=b-i,b=0,k=g);if(null==e._buffer)e._buffer=document.createElement("canvas"),e._buffer.width=this._context.canvas.width,e._buffer.height=this._context.canvas.height;g=e._buffer.getContext("2d");this._doubledImage?(g.clearRect(0,0,2*l,2*k),g.drawImage(this._context.canvas,2*m,2*f,2*l,2*k,0,0,2*l,2*k),g=this._context,g.clearRect(2*a,2*b,2*l,2*k),g.drawImage(e._buffer,0,0,2*l,2*k,2*a,2*b,2*l,2*k)):(g.clearRect(0,0,l,k),g.drawImage(this._context.canvas,m,
f,l,k,0,0,l,k),g=this._context,g.clearRect(a,b,l,k),g.drawImage(e._buffer,0,0,l,k,a,b,l,k));0==a?this.redraw(l,0,e.width-l,e.height):this.redraw(0,0,e.width-l,e.height);0==b?this.redraw(0,k,e.width,e.height-k):this.redraw(0,0,e.width,e.height-k)}else this.redraw(0,0,e.width,e.height)}else this.redraw(0,0,e.width,e.height);this._previousOffsetX=this._offsetX;this._previousOffsetY=this._offsetY})},loadData:function(a){this._data=Array.prototype.slice.apply(arguments);this._dirty=!0;this._tight=!1;for(var b=
0,c=this._data.length;b<c;b++){for(var d=0,a=this._data[b],h=0,e=a.length;h<e;h++)for(var i=0,f=a[h].length;i<f;i++)0<=a[h][i]&&d++;if(0.2<d/(a.length*a[0].length)){this._tight=!0;break}}},hitTest:function(a,b){if(0>a||this.width<=a||0>b||this.height<=b)return!1;var c=this._image.width,d=this._image.height,h=this._tileWidth||c,e=this._tileHeight||d,a=a/h|0,b=b/e|0;if(null!=this.collisionData)return this.collisionData[b]&&!!this.collisionData[b][a];for(var i=0,f=this._data.length;i<f;i++){var l=this._data[i],
g;if(null!=l[b]&&null!=(g=l[b][a])&&0<=g&&g<(c/h|0)*(d/e|0))return!0}return!1},image:{get:function(){return this._image},set:function(a){this._image=a;if(g&&2==e.scale){for(var b=new enchant.Surface(2*a.width,2*a.height),c=this._tileWidth||a.width,d=this._tileHeight||a.height,h=a.width/c|0,j=a.height/d|0,i=0;i<j;i++)for(var f=0;f<h;f++)b.draw(a,f*c,i*d,c,d,2*f*c,2*i*d,2*c,2*d);this._doubledImage=b}this._dirty=!0}},tileWidth:{get:function(){return this._tileWidth},set:function(a){this._tileWidth=a;
this._dirty=!0}},tileHeight:{get:function(){return this._tileHeight},set:function(a){this._tileHeight=a;this._dirty=!0}},width:{get:function(){return this._tileWidth*this._data[0][0].length}},height:{get:function(){return this._tileHeight*this._data[0].length}},redraw:function(a,b,c,d){if(null!=this._image){var h,e,i,f,g;this._doubledImage?(h=this._doubledImage,e=2*this._tileWidth,i=2*this._tileHeight,f=2*-this._offsetX,g=2*-this._offsetY,a*=2,b*=2,c*=2,d*=2):(h=this._image,e=this._tileWidth,i=this._tileHeight,
f=-this._offsetX,g=-this._offsetY);var k=h.width/e|0,m=h.height/i|0,n=Math.max((a+f)/e|0,0),t=Math.max((b+g)/i|0,0),u=Math.ceil((a+f+c)/e),q=Math.ceil((b+g+d)/i);h=h._element;var s=this._context;s.clearRect(a,b,c,d);c=0;for(d=this._data.length;c<d;c++)for(var r=this._data[c],v=Math.min(u,r[0].length),w=Math.min(q,r.length),b=t;b<w;b++)for(a=n;a<v;a++){var p=r[b][a];0<=p&&p<k*m&&s.drawImage(h,p%k*e,(p/k|0)*i,e,i,a*e-f,b*i-g,e,i)}}}});enchant.Group=enchant.Class.create(enchant.Node,{initialize:function(){enchant.Node.call(this);
...
a.childNodes&&e.apply(d,a.childNodes.reverse());if(c.childNodes.length){for(var j,b=this;b.parentNode;){d=b.parentNode.childNodes;for(d=d.slice(d.indexOf(b)+1).reverse();d.length;)if(a=d.pop(),a._element){j=a._element;break}else a.childNodes&&e.apply(d,a.childNodes.slice().reverse());b=b.parentNode}j?this.scene._element.insertBefore(c,j):this.scene._element.appendChild(c)}}},insertBefore:function(a,b){var c=this.childNodes.indexOf(b);if(-1!=c){if(this.childNodes.splice(c,0,a),a.parentNode=this,a.dispatchEvent(new enchant.Event("added")),
this.scene){var d=new enchant.Event("addedtoscene");a.scene=this.scene;a.dispatchEvent(d);a._updateCoordinate();var e=document.createDocumentFragment(),j,i=Array.prototype.push;if(a._element)e.appendChild(a._element);else if(a.childNodes)for(j=a.childNodes.slice().reverse();j.length;)a=j.pop(),a.scene=this.scene,a.dispatchEvent(d),a._element?e.appendChild(a._element):a.childNodes&&i.apply(j,a.childNodes.reverse());if(e.childNodes.length){for(var f,d=b;d.parentNode;){null!=c?(j=this.childNodes.slice(c+
1).reverse(),c=null):(j=d.parentNode.childNodes,j=j.slice(j.indexOf(d)+1).reverse());for(;j.length;)if(a=j.pop(),a._element){f=a._element;break}else a.childNodes&&i.apply(j,a.childNodes.slice().reverse());d=d.parentNode}f?this.scene._element.insertBefore(e,f):this.scene._element.appendChild(e)}}}else this.addChild(a)},removeChild:function(a){var b=this.childNodes.indexOf(a);if(-1!=b&&(this.childNodes.splice(b,1),a.parentNode=null,a.dispatchEvent(new enchant.Event("removed")),this.scene))if(b=new enchant.Event("removedfromscene"),
...
arguments);a.transformOrigin="0 0"},rotation:{get:function(){return this._rotation},set:function(a){var b=a-this._rotation;if(0!=b){for(var c=b/180*Math.PI,d=Math.sin(c),c=Math.cos(c),e=this.width/2,j=this.height/2,i=0,f=this.childNodes.length;i<f;i++){var g=this.childNodes[i];g.rotation-=b;var k=g.x-e,m=g.y-j;g.x=+c*k+d*m+e;g.y=-d*k+c*m+j}this._rotation=a}}}});enchant.Scene=enchant.Class.create(enchant.Group,{initialize:function(){enchant.Group.call(this);this._element=document.createElement("div");
this._element.style.position="absolute";this._element.style.overflow="hidden";this._element.style.width=(this.width=e.width)+"px";this._element.style.height=(this.height=e.height)+"px";this._element.style[f+"TransformOrigin"]="0 0";this._element.style[f+"Transform"]="scale("+e.scale+")";this.scene=this;var a=this;m?(this._element.addEventListener("touchstart",function(b){for(var c=b.touches,d=0,e=c.length;d<e;d++)b=new enchant.Event("touchstart"),b.identifier=c[d].identifier,b._initPosition(c[d].pageX,
...
function(b){var c=b.pageX,d=b.pageY,b=new enchant.Event("touchstart");b.identifier=e._mousedownID;b._initPosition(c,d);a.dispatchEvent(b);a._mousedown=!0},!1),e._element.addEventListener("mousemove",function(b){if(a._mousedown){var c=b.pageX,d=b.pageY,b=new enchant.Event("touchmove");b.identifier=e._mousedownID;b._initPosition(c,d);a.dispatchEvent(b)}},!1),e._element.addEventListener("mouseup",function(b){if(a._mousedown){var c=b.pageX,d=b.pageY,b=new enchant.Event("touchend");b.identifier=e._mousedownID;
