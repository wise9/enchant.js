...
*/
if(typeof Object.defineProperty!="function")Object.defineProperty=function(g,l,f){if("value"in f)g[l]=f.value;"get"in f&&g.__defineGetter__(l,f.get);"set"in f&&g.__defineSetter__(l,f.set);return g};if(typeof Object.defineProperties!="function")Object.defineProperties=function(g,l){for(var f in l)l.hasOwnProperty(f)&&Object.defineProperty(g,f,l[f]);return g};
if(typeof Object.create!="function")Object.create=function(g,l){function f(){}f.prototype=g;var c=new f;l!=null&&Object.defineProperties(c,l);return c};if(typeof Object.getPrototypeOf!="function")Object.getPrototypeOf=function(g){return g.__proto__};
var enchant=function(g){g!=null&&(g instanceof Array||(g=Array.prototype.slice.call(arguments)),g=g.filter(function(g){return""+g}));(function f(c,n){var a=[],b;for(b in c)c.hasOwnProperty(b)&&(typeof c[b]=="function"?window[b]=c[b]:Object.getPrototypeOf(c[b])==Object.prototype&&(g==null?a.push(b):(e=g.indexOf(n+b),e!=-1&&(a.push(b),g.splice(e,1)))));var e=0;for(b=a.length;e<b;e++)f(c[a[e]],n+a[e]+".")})(enchant,"");if(g!=null&&g.length)throw Error("Cannot load module: "+g.join(", "));};
(function(){var g=function(){var a=navigator.userAgent;return a.indexOf("Opera")!=-1?"O":a.indexOf("MSIE")!=-1?"ms":a.indexOf("WebKit")!=-1?"webkit":navigator.product=="Gecko"?"Moz":""}(),l=function(){var a=document.createElement("div");a.setAttribute("ontouchstart","return");return typeof a.ontouchstart=="function"}(),f=function(){if(navigator.userAgent.indexOf("iPhone")!=-1&&window.devicePixelRatio==2){var a=document.querySelector('meta[name="viewport"]');a==null&&(a=document.createElement("meta"),
...
Object.prototype&&q(a[b])})(enchant);this._scenes=[];this.currentScene=null;this.rootScene=new enchant.Scene;this.pushScene(this.rootScene);this.loadingScene=new enchant.Scene;this.loadingScene.backgroundColor="#000";var i=this.width*0.9|0,o=this.width*0.3|0,k=i*0.05|0,d=new enchant.Sprite(i,o);d.x=(this.width-i)/2;d.y=(this.height-o)/2;var j=new enchant.Surface(i,o);j.context.fillStyle="#fff";j.context.fillRect(0,0,i,o);j.context.fillStyle="#000";j.context.fillRect(k,k,i-k*2,o-k*2);d.image=j;var g=
0,f=0;this.addEventListener("progress",function(a){g=a.loaded/a.total});d.addEventListener("enterframe",function(){f*=0.9;f+=g*0.1;j.context.fillStyle="#fff";j.context.fillRect(k,0,(i-k*2)*f,o)});this.loadingScene.addChild(d);this._soundID=this._surfaceID=this._mousedownID=0;this._intervalID=null;this.input={};this._keybind={};this.keybind(37,"left");this.keybind(38,"up");this.keybind(39,"right");this.keybind(40,"down");var n=0;["left","right","up","down","a","b"].forEach(function(a){this.addEventListener(a+
"buttondown",function(b){this.input[a]||(this.input[a]=!0,this.dispatchEvent(new enchant.Event(n++?"inputchange":"inputstart")));this.currentScene.dispatchEvent(b)});this.addEventListener(a+"buttonup",function(b){this.input[a]&&(this.input[a]=!1,this.dispatchEvent(new enchant.Event(--n?"inputchange":"inputend")));this.currentScene.dispatchEvent(b)})},this);e&&(document.addEventListener("keydown",function(a){c.dispatchEvent(new enchant.Event("keydown"));if(37<=a.keyCode&&a.keyCode<=40||a.keyCode==
...
a);var e=d.getResponseHeader("Content-Type")||"";e.match(/^image/)?(c.assets[a]=enchant.Surface.load(a),c.assets[a].addEventListener("load",b)):e.match(/^audio/)?(c.assets[a]=enchant.Sound.load(a,e),c.assets[a].addEventListener("load",b)):(c.assets[asset]=d.responseText,b())}};d.send(null)}},start:function(){if(this._intervalID)window.clearInterval(this._intervalID);else if(this._assets.length){if(!enchant.Sound.enabledInMobileSafari&&!c._touched&&g=="webkit"&&l){var a=new Scene;a.backgroundColor=
"#000";var b=Math.round(c.width/10),e=new Sprite(c.width,b);e.y=(c.height-b)/2;e.image=new Surface(c.width,b);e.image.context.fillStyle="#fff";e.image.context.font=b-1+"px bold Helvetica,Arial,sans-serif";var d=e.image.context.measureText("Touch to Start").width;e.image.context.fillText("Touch to Start",(c.width-d)/2,b-1);a.addChild(e);document.addEventListener("touchstart",function(){c._touched=!0;c.removeScene(a);c.start()},!0);c.pushScene(a);return}var m={},b=this._assets.filter(function(a){return a in
m?!1:m[a]=!0}),h=0,e=0,i=b.length;for(;e<i;e++)this.load(b[e],function(){var a=new enchant.Event("progress");a.loaded=++h;a.total=i;c.dispatchEvent(a);h==i&&(c.removeScene(c.loadingScene),c.dispatchEvent(new enchant.Event("load")))});this.pushScene(this.loadingScene)}else this.dispatchEvent(new enchant.Event("load"));this.currentTime=Date.now();this._intervalID=window.setInterval(function(){c._tick()},1E3/this.fps);this.running=!0},_tick:function(){var a=Date.now(),b=new enchant.Event("enterframe");
b.elapsed=a-this.currentTime;this.currentTime=a;for(var a=this.currentScene.childNodes.slice(),e=Array.prototype.push;a.length;){var d=a.pop();d.dispatchEvent(b);d.childNodes&&e.apply(a,d.childNodes)}this.currentScene.dispatchEvent(b);this.dispatchEvent(b);this.dispatchEvent(new enchant.Event("exitframe"));this.frame++},stop:function(){if(this._intervalID)window.clearInterval(this._intervalID),this._intervalID=null;this.running=!1},pause:function(){if(this._intervalID)window.clearInterval(this._intervalID),
this._intervalID=null},pushScene:function(a){this._element.appendChild(a._element);this.currentScene&&this.currentScene.dispatchEvent(new enchant.Event("exit"));this.currentScene=a;this.currentScene.dispatchEvent(new enchant.Event("enter"));return this._scenes.push(a)},popScene:function(){if(this.currentScene!=this.rootScene)return this._element.removeChild(this.currentScene._element),this.currentScene.dispatchEvent(new enchant.Event("exit")),this.currentScene=this._scenes[this._scenes.length-2],
this.currentScene.dispatchEvent(new enchant.Event("enter")),this._scenes.pop()},replaceScene:function(a){this.popScene();return this.pushScene(a)},removeScene:function(a){if(this.currentScene==a)return this.popScene();else{var b=this._scenes.indexOf(a);if(b!=-1)return this._scenes.splice(b,1),this._element.removeChild(a._element),a}},keybind:function(a,b){this._keybind[a]=b}});enchant.Game.instance=null;enchant.Node=enchant.Class.create(enchant.EventTarget,{initialize:function(){enchant.EventTarget.call(this);
this._offsetY=this._offsetX=this._y=this._x=0;this.scene=this.parentNode=null;this.addEventListener("touchstart",function(a){this.parentNode&&this.parentNode!=this.scene&&this.parentNode.dispatchEvent(a)});this.addEventListener("touchmove",function(a){this.parentNode&&this.parentNode!=this.scene&&this.parentNode.dispatchEvent(a)});this.addEventListener("touchend",function(a){this.parentNode&&this.parentNode!=this.scene&&this.parentNode.dispatchEvent(a)})},moveTo:function(a,b){this._x=a;this._y=b;
this._updateCoordinate()},moveBy:function(a,b){this._x+=a;this._y+=b;this._updateCoordinate()},x:{get:function(){return this._x},set:function(a){this._x=a;this._updateCoordinate()}},y:{get:function(){return this._y},set:function(a){this._y=a;this._updateCoordinate()}},_updateCoordinate:function(){this.parentNode?(this._offsetX=this.parentNode._offsetX+this._x,this._offsetY=this.parentNode._offsetY+this._y):(this._offsetX=this._x,this._offsetY=this._y)}});enchant.Entity=enchant.Class.create(enchant.Node,
{initialize:function(){enchant.Node.call(this);this._element=document.createElement("div");this._style=this._element.style;this._style.position="absolute";this._height=this._width=0;this._backgroundColor=null;this._opacity=1;this._visible=!0;this.buttonMode=this._buttonMode=null;this.buttonPressed=!1;this.addEventListener("touchstart",function(){if(this.buttonMode){this.buttonPressed=!0;var a=new Event(button+"buttondown");this.dispatchEvent(a);c.dispatchEvent(a)}});this.addEventListener("touchend",
function(){if(this.buttonMode){this.buttonPressed=!1;var a=new Event(button+"buttonup");this.dispatchEvent(a);c.dispatchEvent(a)}});var a=this,b=function(){a.dispatchEvent(new enchant.Event("render"))};this.addEventListener("addedtoscene",function(){b();c.addEventListener("exitframe",b)});this.addEventListener("removedfromscene",function(){c.removeEventListener("exitframe",b)});this.addEventListener("render",function(){if(this._offsetX!=this._previousOffsetX)this._style.left=this._offsetX+"px";if(this._offsetY!=
this._previousOffsetY)this._style.top=this._offsetY+"px";this._previousOffsetX=this._offsetX;this._previousOffsetY=this._offsetY});a=this;l?(this._element.addEventListener("touchstart",function(b){for(var d=b.touches,c=0,h=d.length;c<h;c++)b=new enchant.Event("touchstart"),b.identifier=d[c].identifier,b._initPosition(d[c].pageX,d[c].pageY),a.dispatchEvent(b)},!1),this._element.addEventListener("touchmove",function(b){for(var d=b.touches,c=0,h=d.length;c<h;c++)b=new enchant.Event("touchmove"),b.identifier=
d[c].identifier,b._initPosition(d[c].pageX,d[c].pageY),a.dispatchEvent(b)},!1),this._element.addEventListener("touchend",function(b){for(var d=b.changedTouches,c=0,h=d.length;c<h;c++)b=new enchant.Event("touchend"),b.identifier=d[c].identifier,b._initPosition(d[c].pageX,d[c].pageY),a.dispatchEvent(b)},!1)):(this._element.addEventListener("mousedown",function(b){var d=b.pageX,m=b.pageY,b=new enchant.Event("touchstart");b.identifier=c._mousedownID;b._initPosition(d,m);a.dispatchEvent(b);a._mousedown=
!0},!1),c._element.addEventListener("mousemove",function(b){if(a._mousedown){var d=b.pageX,m=b.pageY,b=new enchant.Event("touchmove");b.identifier=c._mousedownID;b._initPosition(d,m);a.dispatchEvent(b)}},!1),c._element.addEventListener("mouseup",function(b){if(a._mousedown){var d=b.pageX,m=b.pageY,b=new enchant.Event("touchend");b.identifier=c._mousedownID;b._initPosition(d,m);a.dispatchEvent(b);a._mousedown=!1}},!1))},width:{get:function(){return this._width},set:function(a){this._style.width=(this._width=
...
b;this._scaleY=this._scaleX=1;this._rotation=0;this._dirty=!1;this._image=null;this._frame=0;this._style.overflow="hidden";this.addEventListener("render",function(){if(this._dirty)this._style[g+"Transform"]=["rotate(",this._rotation,"deg)scale(",this._scaleX,",",this._scaleY,")"].join(""),this._dirty=!1})},image:{get:function(){return this._image},set:function(a){if(a!=this._image){if(this._image!=null)if(this._image.css)this._style.backgroundImage="";else if(this._element.firstChild)this._element.removeChild(this._element.firstChild),
this._dirtyListener?(this.removeEventListener("render",this._dirtyListener),this._dirtyListener=null):this._image._parent=null;if(a!=null)if(a._css)this._style.backgroundImage=a._css;else if(a._parent){var b=document.createElement("canvas"),e=b.getContext("2d");b.width=a.width;b.height=a.height;e.drawImage(a._element,0,0);this._dirtyListener=function(){if(a._dirty)e.drawImage(a._element),a._dirty=!1};this.addEventListener("render",this._dirtyListener);this._element.appendChild(b)}else a._parent=this,
...
a}},font:{get:function(){return this._style.font},set:function(a){this._style.font=a}},color:{get:function(){return this._style.color},set:function(a){this._style.color=a}}});enchant.Map=enchant.Class.create(enchant.Entity,{initialize:function(a,b){enchant.Entity.call(this);var e=document.createElement("canvas");f&&c.scale==2?(e.width=c.width*2,e.height=c.height*2,this._style.webkitTransformOrigin="0 0",this._style.webkitTransform="scale(0.5)"):(e.width=c.width,e.height=c.height);this._element.appendChild(e);
...
i=-this._previousOffsetY,g=a-e+c.width,k=e-a+c.width,j=b-i+c.height,f=i-b+c.height;if(g>this._tileWidth&&k>this._tileWidth&&j>this._tileHeight&&f>this._tileHeight){var l;g<k?(l=0,a=e-a,k=g):(l=a-e,a=0);j<f?(g=0,b=i-b):(g=b-i,b=0,j=f);if(c._buffer==null)c._buffer=document.createElement("canvas"),c._buffer.width=this._context.canvas.width,c._buffer.height=this._context.canvas.height;f=c._buffer.getContext("2d");this._doubledImage?(f.clearRect(0,0,k*2,j*2),f.drawImage(this._context.canvas,l*2,g*2,k*
2,j*2,0,0,k*2,j*2),f=this._context,f.clearRect(a*2,b*2,k*2,j*2),f.drawImage(c._buffer,0,0,k*2,j*2,a*2,b*2,k*2,j*2)):(f.clearRect(0,0,k,j),f.drawImage(this._context.canvas,l,g,k,j,0,0,k,j),f=this._context,f.clearRect(a,b,k,j),f.drawImage(c._buffer,0,0,k,j,a,b,k,j));a==0?this.redraw(k,0,c.width-k,c.height):this.redraw(0,0,c.width-k,c.height);b==0?this.redraw(0,j,c.width,c.height-j):this.redraw(0,0,c.width,c.height-j)}else this.redraw(0,0,c.width,c.height)}else this.redraw(0,0,c.width,c.height);this._previousOffsetX=
this._offsetX;this._previousOffsetY=this._offsetY})},loadData:function(a){this._data=Array.prototype.slice.apply(arguments);this._dirty=!0;this._tight=!1;for(var b=0,e=this._data.length;b<e;b++){for(var d=0,a=this._data[b],c=0,h=a.length;c<h;c++)for(var i=0,g=a[c].length;i<g;i++)a[c][i]>=0&&d++;if(d/(a.length*a[0].length)>0.2){this._tight=!0;break}}},hitTest:function(a,b){if(a<0||this.width<=a||b<0||this.height<=b)return!1;var e=this._image.width,d=this._image.height,c=this._tileWidth||e,h=this._tileHeight||
d,a=a/c|0,b=b/h|0;if(this.collisionData!=null)return this.collisionData[b]&&!!this.collisionData[b][a];else{for(var i=0,g=this._data.length;i<g;i++){var f=this._data[i],j;if(f[b]!=null&&(j=f[b][a])!=null&&0<=j&&j<(e/c|0)*(d/h|0))return!0}return!1}},image:{get:function(){return this._image},set:function(a){this._image=a;if(f&&c.scale==2){for(var b=new Surface(a.width*2,a.height*2),e=this._tileWidth||a.width,d=this._tileHeight||a.height,m=a.width/e|0,h=a.height/d|0,i=0;i<h;i++)for(var g=0;g<m;g++)b.draw(a,
g*e,i*d,e,d,g*e*2,i*d*2,e*2,d*2);this._doubledImage=b}this._dirty=!0}},tileWidth:{get:function(){return this._tileWidth},set:function(a){this._tileWidth=a;this._dirty=!0}},tileHeight:{get:function(){return this._tileHeight},set:function(a){this._tileHeight=a;this._dirty=!0}},width:{get:function(){return this._tileWidth*this._data[0][0].length}},height:{get:function(){return this._tileHeight*this._data[0].length}},redraw:function(a,b,e,d){if(this._image!=null){var c,h,i,g,f;this._doubledImage?(c=this._doubledImage,
h=this._tileWidth*2,i=this._tileHeight*2,g=-this._offsetX*2,f=-this._offsetY*2,a*=2,b*=2,e*=2,d*=2):(c=this._image,h=this._tileWidth,i=this._tileHeight,g=-this._offsetX,f=-this._offsetY);var j=c.width/h|0,l=c.height/i|0,n=Math.max((a+g)/h|0,0),t=Math.max((b+f)/i|0,0),u=Math.ceil((a+g+e)/h),q=Math.ceil((b+f+d)/i);c=c._element;var s=this._context;s.clearRect(a,b,e,d);e=0;for(d=this._data.length;e<d;e++)for(var r=this._data[e],v=Math.min(u,r[0].length),w=Math.min(q,r.length),b=t;b<w;b++)for(a=n;a<v;a++){var p=
...
b.src=a;b.onerror=function(){throw Error("Cannot load an asset: "+b.src);};b.onload=function(){c.width=b.width;c.height=b.height;c.dispatchEvent(new enchant.Event("load"))};return c};enchant.Sound=enchant.Class.create(enchant.EventTarget,{initialize:function(){enchant.EventTarget.call(this);throw Error("Illegal Constructor");},play:function(){this._element&&this._element.play()},pause:function(){this._element&&this._element.pause()},stop:function(){this.pause();this.currentTime=0},clone:function(){return this._element instanceof
Audio?Object.create(enchant.Sound.prototype,{_element:{value:this._element.cloneNode()},duration:{value:this.duration}}):Object.create(enchant.Sound.prototype)},currentTime:{get:function(){return this._element?this._element.currentTime:0},set:function(a){if(this._element)this._element.currentTime=a}},volume:{get:function(){return this._element?this._element.volume:1},set:function(a){if(this._element)this._element.volume=a}}});enchant.Sound.load=function(a,b){if(b==null)var e=a.match(/\.\w+$/)[0],
b=e?"audio/"+e.slice(1).toLowerCase():"";var d=Object.create(enchant.Sound.prototype);enchant.EventTarget.call(d);var f=new Audio;if(!enchant.Sound.enabledInMobileSafari&&g=="webkit"&&l)window.setTimeout(function(){d.dispatchEvent(new enchant.Event("load"))},0);else if(f.canPlayType(b))f.src=a,f.load(),f.autoplay=!1,f.onerror=function(){throw Error("Cannot load an asset: "+f.src);},f.addEventListener("canplaythrough",function(){d.duration=f.duration;d.dispatchEvent(new enchant.Event("load"))},!1),
d._element=f;else if(b.match(/^audio\/(mpeg|mp3)/)){var h=document.createElement("embed"),e="enchant-audio"+c._soundID++;h.width=h.height=1;h.name=e;h.src="sound.swf?id=&src="+a;h.allowscriptaccess="always";h.style.position="absolute";h.style.left="-1px";d.addEventListener("load",function(){Object.defineProperties(h,{currentTime:{get:function(){return h.getCurrentTime()},set:function(a){h.setCurrentTime(a)}},volume:{get:function(){return h.getVolume()},set:function(a){h.setVolume(a)}}});d._element=
h;d.duration=h.getDuration()});c._element.appendChild(h);enchant.Sound[e]=d}else window.setTimeout(function(){d.dispatchEvent(new enchant.Event("load"))},0);return d};enchant.Sound.enabledInMobileSafari=!1})();
