...
a.keyCode<=40||a.keyCode==32){a.preventDefault();a.stopPropagation()}if(c.running)if(a=c._keybind[a.keyCode]){a=new enchant.Event(a+"buttondown");c.dispatchEvent(a)}},true);d.addEventListener("keyup",function(a){if(c.running)if(a=c._keybind[a.keyCode]){a=new enchant.Event(a+"buttonup");c.dispatchEvent(a)}},true);if(m){d.addEventListener("touchstart",function(a){a.preventDefault()},true);d.addEventListener("touchmove",function(a){a.preventDefault();c.running||a.stopPropagation()},true);d.addEventListener("touchend",
function(a){a.preventDefault();c.running||a.stopPropagation()},true)}else{d.addEventListener("mousedown",function(a){var b=a.target.tagName.toLowerCase();if(b!=="input"&&b!=="textarea"){a.preventDefault();c._mousedownID++;c.running||a.stopPropagation()}},true);d.addEventListener("mousemove",function(a){var b=a.target.tagName.toLowerCase();if(b!=="input"&&b!=="textarea"){a.preventDefault();c.running||a.stopPropagation()}},true);d.addEventListener("mouseup",function(a){var b=a.target.tagName.toLowerCase();
