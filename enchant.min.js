...
new enchant.Scene;a.backgroundColor="#000";var b=Math.round(e.width/10),d=new enchant.Sprite(e.width,b);d.y=(e.height-b)/2;d.image=new enchant.Surface(e.width,b);d.image.context.fillStyle="#fff";d.image.context.font=b-1+"px bold Helvetica,Arial,sans-serif";var c=d.image.context.measureText("Touch to Start").width;d.image.context.fillText("Touch to Start",(e.width-c)/2,b-1);a.addChild(d);document.addEventListener("touchstart",function(){e._touched=true;e.removeScene(a);e.start()},true);e.pushScene(a);
return}var m={},b=this._assets.filter(function(a){return a in m?false:m[a]=true}),g=0,d=0,h=b.length;for(;d<h;d++)this.load(b[d],function(){var a=new enchant.Event("progress");a.loaded=++g;a.total=h;e.dispatchEvent(a);if(g==h){e.removeScene(e.loadingScene);e.dispatchEvent(new enchant.Event("load"))}});this.pushScene(this.loadingScene)}else this.dispatchEvent(new enchant.Event("load"));this.currentTime=Date.now();this._intervalID=window.setInterval(function(){e._tick()},1E3/this.fps);this.running=
...
replaceScene:function(a){this.popScene();return this.pushScene(a)},removeScene:function(a){if(this.currentScene==a)return this.popScene();var b=this._scenes.indexOf(a);if(b!=-1){this._scenes.splice(b,1);this._element.removeChild(a._element);return a}},keybind:function(a,b){this._keybind[a]=b},getElapsedTime:function(){return this.frame/this.fps}});enchant.Game.instance=null;enchant.Node=enchant.Class.create(enchant.EventTarget,{initialize:function(){enchant.EventTarget.call(this);this.age=this._offsetY=
this._offsetX=this._y=this._x=0;this.scene=this.parentNode=null;this.addEventListener("touchstart",function(a){this.parentNode&&this.parentNode!=this.scene&&this.parentNode.dispatchEvent(a)});this.addEventListener("touchmove",function(a){this.parentNode&&this.parentNode!=this.scene&&this.parentNode.dispatchEvent(a)});this.addEventListener("touchend",function(a){this.parentNode&&this.parentNode!=this.scene&&this.parentNode.dispatchEvent(a)})},moveTo:function(a,b){this._x=a;this._y=b;this._updateCoordinate()},
...
function(){if(this.buttonMode){this.buttonPressed=true;var a=new enchant.Event(this.buttonMode+"buttondown");this.dispatchEvent(a);e.dispatchEvent(a)}});this.addEventListener("touchend",function(){if(this.buttonMode){this.buttonPressed=false;var a=new enchant.Event(this.buttonMode+"buttonup");this.dispatchEvent(a);e.dispatchEvent(a)}});var a=this,b=function(){a.dispatchEvent(new enchant.Event("render"))};this.addEventListener("addedtoscene",function(){b();e.addEventListener("exitframe",b)});this.addEventListener("removedfromscene",
function(){e.removeEventListener("exitframe",b)});this.addEventListener("render",function(){if(this._offsetX!=this._previousOffsetX)this._style.left=this._offsetX+"px";if(this._offsetY!=this._previousOffsetY)this._style.top=this._offsetY+"px";this._previousOffsetX=this._offsetX;this._previousOffsetY=this._offsetY});a=this;if(l){this._element.addEventListener("touchstart",function(b){for(var c=b.touches,e=0,g=c.length;e<g;e++){b=new enchant.Event("touchstart");b.identifier=c[e].identifier;b._initPosition(c[e].pageX,
c[e].pageY);a.dispatchEvent(b)}},false);this._element.addEventListener("touchmove",function(b){for(var c=b.touches,e=0,g=c.length;e<g;e++){b=new enchant.Event("touchmove");b.identifier=c[e].identifier;b._initPosition(c[e].pageX,c[e].pageY);a.dispatchEvent(b)}},false);this._element.addEventListener("touchend",function(b){for(var c=b.changedTouches,e=0,g=c.length;e<g;e++){b=new enchant.Event("touchend");b.identifier=c[e].identifier;b._initPosition(c[e].pageX,c[e].pageY);a.dispatchEvent(b)}},false)}else{this._element.addEventListener("mousedown",
function(b){var c=b.pageX,m=b.pageY,b=new enchant.Event("touchstart");b.identifier=e._mousedownID;b._initPosition(c,m);a.dispatchEvent(b);a._mousedown=true},false);e._element.addEventListener("mousemove",function(b){if(a._mousedown){var c=b.pageX,m=b.pageY,b=new enchant.Event("touchmove");b.identifier=e._mousedownID;b._initPosition(c,m);a.dispatchEvent(b)}},false);e._element.addEventListener("mouseup",function(b){if(a._mousedown){var c=b.pageX,m=b.pageY,b=new enchant.Event("touchend");b.identifier=
e._mousedownID;b._initPosition(c,m);a.dispatchEvent(b);a._mousedown=false}},false)}},id:{get:function(){return this._element.id},set:function(a){this._element.id=a}},className:{get:function(){return this._element.className},set:function(a){this._element.className=a}},width:{get:function(){return this._width},set:function(a){this._style.width=(this._width=a)+"px"}},height:{get:function(){return this._height},set:function(a){this._style.height=(this._height=a)+"px"}},backgroundColor:{get:function(){return this._backgroundColor},
...
var d=document.createElement("canvas");if(o&&e.scale==2){d.width=e.width*2;d.height=e.height*2;this._style.webkitTransformOrigin="0 0";this._style.webkitTransform="scale(0.5)"}else{d.width=e.width;d.height=e.height}this._element.appendChild(d);this._context=d.getContext("2d");this._tileWidth=a||0;this._tileHeight=b||0;this._image=null;this._data=[[[]]];this.touchEnabled=this._tight=this._dirty=false;this.collisionData=null;this._listeners.render=null;this.addEventListener("render",function(){if(this._dirty||
this._previousOffsetX==null){this._dirty=false;this.redraw(0,0,e.width,e.height)}else if(this._offsetX!=this._previousOffsetX||this._offsetY!=this._previousOffsetY)if(this._tight){var a=-this._offsetX,b=-this._offsetY,d=-this._previousOffsetX,h=-this._previousOffsetY,p=a-d+e.width,i=d-a+e.width,j=b-h+e.height,f=h-b+e.height;if(p>this._tileWidth&&i>this._tileWidth&&j>this._tileHeight&&f>this._tileHeight){var k;if(p<i){k=0;a=d-a;i=p}else{k=a-d;a=0}if(j<f){p=0;b=h-b}else{p=b-h;b=0;j=f}if(e._buffer==
null){e._buffer=document.createElement("canvas");e._buffer.width=this._context.canvas.width;e._buffer.height=this._context.canvas.height}f=e._buffer.getContext("2d");if(this._doubledImage){f.clearRect(0,0,i*2,j*2);f.drawImage(this._context.canvas,k*2,p*2,i*2,j*2,0,0,i*2,j*2);f=this._context;f.clearRect(a*2,b*2,i*2,j*2);f.drawImage(e._buffer,0,0,i*2,j*2,a*2,b*2,i*2,j*2)}else{f.clearRect(0,0,i,j);f.drawImage(this._context.canvas,k,p,i,j,0,0,i,j);f=this._context;f.clearRect(a,b,i,j);f.drawImage(e._buffer,
0,0,i,j,a,b,i,j)}a==0?this.redraw(i,0,e.width-i,e.height):this.redraw(0,0,e.width-i,e.height);b==0?this.redraw(0,j,e.width,e.height-j):this.redraw(0,0,e.width,e.height-j)}else this.redraw(0,0,e.width,e.height)}else this.redraw(0,0,e.width,e.height);this._previousOffsetX=this._offsetX;this._previousOffsetY=this._offsetY})},loadData:function(a){this._data=Array.prototype.slice.apply(arguments);this._dirty=true;this._tight=false;for(var b=0,d=this._data.length;b<d;b++){for(var c=0,a=this._data[b],e=
0,g=a.length;e<g;e++)for(var h=0,f=a[e].length;h<f;h++)a[e][h]>=0&&c++;if(c/(a.length*a[0].length)>0.2){this._tight=true;break}}},hitTest:function(a,b){if(a<0||this.width<=a||b<0||this.height<=b)return false;var d=this._image.width,c=this._image.height,e=this._tileWidth||d,g=this._tileHeight||c,a=a/e|0,b=b/g|0;if(this.collisionData!=null)return this.collisionData[b]&&!!this.collisionData[b][a];for(var h=0,f=this._data.length;h<f;h++){var i=this._data[h],j;if(i[b]!=null&&(j=i[b][a])!=null&&0<=j&&j<
(d/e|0)*(c/g|0))return true}return false},image:{get:function(){return this._image},set:function(a){this._image=a;if(o&&e.scale==2){for(var b=new enchant.Surface(a.width*2,a.height*2),d=this._tileWidth||a.width,c=this._tileHeight||a.height,m=a.width/d|0,g=a.height/c|0,h=0;h<g;h++)for(var f=0;f<m;f++)b.draw(a,f*d,h*c,d,c,f*d*2,h*c*2,d*2,c*2);this._doubledImage=b}this._dirty=true}},tileWidth:{get:function(){return this._tileWidth},set:function(a){this._tileWidth=a;this._dirty=true}},tileHeight:{get:function(){return this._tileHeight},
set:function(a){this._tileHeight=a;this._dirty=true}},width:{get:function(){return this._tileWidth*this._data[0][0].length}},height:{get:function(){return this._tileHeight*this._data[0].length}},redraw:function(a,b,d,c){if(this._image!=null){var e,g,h,f,i;if(this._doubledImage){e=this._doubledImage;g=this._tileWidth*2;h=this._tileHeight*2;f=-this._offsetX*2;i=-this._offsetY*2;a=a*2;b=b*2;d=d*2;c=c*2}else{e=this._image;g=this._tileWidth;h=this._tileHeight;f=-this._offsetX;i=-this._offsetY}var j=e.width/
g|0,k=e.height/h|0,l=Math.max((a+f)/g|0,0),n=Math.max((b+i)/h|0,0),o=Math.ceil((a+f+d)/g),q=Math.ceil((b+i+c)/h);e=e._element;var t=this._context;t.clearRect(a,b,d,c);d=0;for(c=this._data.length;d<c;d++)for(var s=this._data[d],v=Math.min(o,s[0].length),w=Math.min(q,s.length),b=n;b<w;b++)for(a=l;a<v;a++){var r=s[b][a];0<=r&&r<j*k&&t.drawImage(e,r%j*g,(r/j|0)*h,g,h,a*g-f,b*h-i,g,h)}}}});enchant.Group=enchant.Class.create(enchant.Node,{initialize:function(){enchant.Node.call(this);this.childNodes=[];
...
throw Error("Illegal Constructor");},play:function(){this._element&&this._element.play()},pause:function(){this._element&&this._element.pause()},stop:function(){this.pause();this.currentTime=0},clone:function(){var a;if(this._element instanceof Audio)a=Object.create(enchant.Sound.prototype,{_element:{value:this._element.cloneNode(false)},duration:{value:this.duration}});else{if(q)return this;a=Object.create(enchant.Sound.prototype)}enchant.EventTarget.call(a);return a},currentTime:{get:function(){return this._element?
this._element.currentTime:0},set:function(a){if(this._element)this._element.currentTime=a}},volume:{get:function(){return this._element?this._element.volume:1},set:function(a){if(this._element)this._element.volume=a}}});enchant.Sound.load=function(a,b){if(b==null)var d=f(a),b=d?"audio/"+d:"";var b=b.replace("mp3","mpeg"),c=Object.create(enchant.Sound.prototype);enchant.EventTarget.call(c);var m=new Audio;if(!enchant.Sound.enabledInMobileSafari&&k=="webkit"&&l)window.setTimeout(function(){c.dispatchEvent(new enchant.Event("load"))},
0);else if(!q&&m.canPlayType(b)){m.src=a;m.load();m.autoplay=false;m.onerror=function(){throw Error("Cannot load an asset: "+m.src);};m.addEventListener("canplaythrough",function(){c.duration=m.duration;c.dispatchEvent(new enchant.Event("load"))},false);c._element=m}else if(b=="audio/mpeg"){var g=document.createElement("embed"),d="enchant-audio"+e._soundID++;g.width=g.height=1;g.name=d;g.src="sound.swf?id="+d+"&src="+a;g.allowscriptaccess="always";g.style.position="absolute";g.style.left="-1px";c.addEventListener("load",
function(){Object.defineProperties(g,{currentTime:{get:function(){return g.getCurrentTime()},set:function(a){g.setCurrentTime(a)}},volume:{get:function(){return g.getVolume()},set:function(a){g.setVolume(a)}}});c._element=g;c.duration=g.getDuration()});e._element.appendChild(g);enchant.Sound[d]=c}else window.setTimeout(function(){c.dispatchEvent(new enchant.Event("load"))},0);return c};window.addEventListener("message",function(a){a=JSON.parse(a.data);if(a.type=="event")e.dispatchEvent(new Event(a.value));
