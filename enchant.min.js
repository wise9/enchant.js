...
Object.prototype&&q(a[b])})(enchant);this._scenes=[];this.currentScene=null;this.rootScene=new enchant.Scene;this.pushScene(this.rootScene);this.loadingScene=new enchant.Scene;this.loadingScene.backgroundColor="#000";var n=this.width*0.9|0,k=this.width*0.3|0,i=n*0.05|0,d=new enchant.Sprite(n,k);d.x=(this.width-n)/2;d.y=(this.height-k)/2;var j=new enchant.Surface(n,k);j.context.fillStyle="#fff";j.context.fillRect(0,0,n,k);j.context.fillStyle="#000";j.context.fillRect(i,i,n-i*2,k-i*2);d.image=j;var f=
0,h=0;this.addEventListener("progress",function(a){f=a.loaded/a.total});d.addEventListener("enterframe",function(){h*=0.9;h+=f*0.1;j.context.fillStyle="#fff";j.context.fillRect(i,0,(n-i*2)*h,k)});this.loadingScene.addChild(d);this._soundID=this._surfaceID=this._mousedownID=0;this._intervalID=null;this.input={};this._keybind={};this.keybind(37,"left");this.keybind(38,"up");this.keybind(39,"right");this.keybind(40,"down");var o=0;["left","right","up","down","a","b"].forEach(function(a){this.addEventListener(a+
