...
*/
"function"!=typeof Object.defineProperty&&(Object.defineProperty=function(f,n,g){"value"in g&&(f[n]=g.value);"get"in g&&f.__defineGetter__(n,g.get);"set"in g&&f.__defineSetter__(n,g.set);return f});"function"!=typeof Object.defineProperties&&(Object.defineProperties=function(f,n){for(var g in n)n.hasOwnProperty(g)&&Object.defineProperty(f,g,n[g]);return f});
"function"!=typeof Object.create&&(Object.create=function(f,n){function g(){}g.prototype=f;var l=new g;n!=null&&Object.defineProperties(l,n);return l});"function"!=typeof Object.getPrototypeOf&&(Object.getPrototypeOf=function(f){return f.__proto__});
"function"!==typeof Function.prototype.bind&&(Function.prototype.bind=function(f){var n=this,g=Array.prototype.slice.call(arguments,1),l=function(){},m=function(){var m=g.concat(Array.prototype.slice.call(arguments));return n.apply(this instanceof l?this:f||window,m)};l.prototype=n.prototype;m.prototype=new l;return m});
var enchant=function(f){if(f!=null){f instanceof Array||(f=Array.prototype.slice.call(arguments));f=f.filter(function(f){return""+f})}(function g(l,m){var r=[],o;for(o in l)if(l.hasOwnProperty(o))if(typeof l[o]=="function")window[o]=l[o];else if(typeof l[o]=="object"&&Object.getPrototypeOf(l[o])==Object.prototype)if(f==null)r.push(o);else{e=f.indexOf(m+o);if(e!=-1){r.push(o);f.splice(e,1)}}var e=0;for(o=r.length;e<o;e++)g(l[r[e]],m+r[e]+".")})(enchant,"");if(f!=null&&f.length)throw Error("Cannot load module: "+
f.join(", "));};
(function(){function f(a){var b=a.match(/\.\w+$/);return b&&b.length>0?b[0].slice(1).toLowerCase():a.indexOf("data:")===0?a.split(/[\/;]/)[1].toLowerCase():null}var n=enchant,g;g=navigator.userAgent;g=g.indexOf("Opera")!=-1?"O":g.indexOf("MSIE")!=-1?"ms":g.indexOf("WebKit")!=-1?"webkit":navigator.product=="Gecko"?"Moz":"";var l;l=document.createElement("div");l.setAttribute("ontouchstart","return");l=typeof l.ontouchstart=="function";var m;if(navigator.userAgent.indexOf("iPhone")!=-1&&window.devicePixelRatio==
2){m=document.querySelector('meta[name="viewport"]');if(m==null){m=document.createElement("meta");document.head.appendChild(m)}m.setAttribute("content","width=640");m=true}else m=false;var r;r=navigator.userAgent;var o=navigator.vendor||"";r=location.href.indexOf("http")==0&&r.indexOf("Mobile")==-1&&o.indexOf("Apple")!=-1;n.ENV={VENDOR_PREFIX:g,TOUCH_ENABLED:l,RETINA_DISPLAY:m,USE_FLASH_SOUND:r,USE_DEFAULT_EVENT_TAGS:["input","textarea","select"]};var e;enchant.Class=function(a,b){return enchant.Class.create(a,
...
if(c){var p=window.getComputedStyle(c),a=parseInt(p.width),b=parseInt(p.height);if(a&&b)this.scale=Math.min(a/this.width,b/this.height);else{c.style.width=this.width+"px";c.style.height=this.height+"px"}for(;c.firstChild;)c.removeChild(c.firstChild);c.style.position="relative";p=c.getBoundingClientRect();this._pageX=Math.round(window.scrollX+p.left);this._pageY=Math.round(window.scrollY+p.top)}else{c=document.createElement("div");c.id="enchant-stage";c.style.width=window.innerWidth+"px";c.style.height=
window.innerHeight+"px";c.style.position="absolute";document.body.firstChild?document.body.insertBefore(c,document.body.firstChild):document.body.appendChild(c);this.scale=Math.min(window.innerWidth/this.width,window.innerHeight/this.height);this._pageY=this._pageX=0}if(!this.scale)this.scale=1;c.style.fontSize="12px";c.style.webkitTextSizeAdjust="none";this._element=c;this.fps=30;this.frame=0;this.ready=null;this.running=false;this.assets={};var h=this._assets=[];(function w(a){a.assets instanceof
Array&&[].push.apply(h,a.assets);for(var b in a)a.hasOwnProperty(b)&&typeof a[b]=="object"&&Object.getPrototypeOf(a[b])==Object.prototype&&w(a[b])})(enchant);this._scenes=[];this.currentScene=null;this.rootScene=new enchant.Scene;this.pushScene(this.rootScene);this.loadingScene=new enchant.Scene;this.loadingScene.backgroundColor="#000";var k=this.width*0.9|0,q=this.width*0.3|0,i=k*0.05|0,c=new enchant.Sprite(k,q);c.x=(this.width-k)/2;c.y=(this.height-q)/2;var j=new enchant.Surface(k,q);j.context.fillStyle=
"#fff";j.context.fillRect(0,0,k,q);j.context.fillStyle="#000";j.context.fillRect(i,i,k-i*2,q-i*2);c.image=j;var f=0,g=0;this.addEventListener("progress",function(a){f=a.loaded/a.total});c.addEventListener("enterframe",function(){g=g*0.9;g=g+f*0.1;j.context.fillStyle="#fff";j.context.fillRect(i,0,(k-i*2)*g,q)});this.loadingScene.addChild(c);this._soundID=this._surfaceID=this._mousedownID=0;this._intervalID=null;this._offsetY=this._offsetX=0;this.input={};this._keybind={};this.keybind(37,"left");this.keybind(38,
...
(e.width-c)/2,b-1);a.addChild(d);document.addEventListener("touchstart",function(){e._touched=true;e.removeScene(a);e.start()},true);e.pushScene(a);return}var p={},b=this._assets.filter(function(a){return a in p?false:p[a]=true}),h=0,d=0,k=b.length;for(;d<k;d++)this.load(b[d],function(){var a=new enchant.Event("progress");a.loaded=++h;a.total=k;e.dispatchEvent(a);if(h==k){e.removeScene(e.loadingScene);e.dispatchEvent(new enchant.Event("load"))}});this.pushScene(this.loadingScene)}else this.dispatchEvent(new enchant.Event("load"));
...
function(b){for(var c=b.touches,e=0,h=c.length;e<h;e++){b=new enchant.Event("touchstart");b.identifier=c[e].identifier;b._initPosition(c[e].pageX,c[e].pageY);a.dispatchEvent(b)}},false);this._element.addEventListener("touchmove",function(b){for(var c=b.touches,e=0,h=c.length;e<h;e++){b=new enchant.Event("touchmove");b.identifier=c[e].identifier;b._initPosition(c[e].pageX,c[e].pageY);a.dispatchEvent(b)}},false);this._element.addEventListener("touchend",function(b){for(var c=b.changedTouches,e=0,h=
c.length;e<h;e++){b=new enchant.Event("touchend");b.identifier=c[e].identifier;b._initPosition(c[e].pageX,c[e].pageY);a.dispatchEvent(b)}},false)}else{this._element.addEventListener("mousedown",function(b){var c=b.pageX,p=b.pageY,b=new enchant.Event("touchstart");b.identifier=e._mousedownID;b._initPosition(c,p);a.dispatchEvent(b);a._mousedown=true},false);e._element.addEventListener("mousemove",function(b){if(a._mousedown){var c=b.pageX,p=b.pageY,b=new enchant.Event("touchmove");b.identifier=e._mousedownID;
b._initPosition(c,p);a.dispatchEvent(b)}},false);e._element.addEventListener("mouseup",function(b){if(a._mousedown){var c=b.pageX,p=b.pageY,b=new enchant.Event("touchend");b.identifier=e._mousedownID;b._initPosition(c,p);a.dispatchEvent(b);a._mousedown=false}},false)}},id:{get:function(){return this._element.id},set:function(a){this._element.id=a}},className:{get:function(){return this._element.className},set:function(a){this._element.className=a}},width:{get:function(){return this._width},set:function(a){this._style.width=
...
if(q>this._tileWidth&&i>this._tileWidth&&j>this._tileHeight&&f>this._tileHeight){var g;if(q<i){g=0;a=d-a;i=q}else{g=a-d;a=0}if(j<f){q=0;b=k-b}else{q=b-k;b=0;j=f}if(e._buffer==null){e._buffer=document.createElement("canvas");e._buffer.width=this._context.canvas.width;e._buffer.height=this._context.canvas.height}f=e._buffer.getContext("2d");if(this._doubledImage){f.clearRect(0,0,i*2,j*2);f.drawImage(this._context.canvas,g*2,q*2,i*2,j*2,0,0,i*2,j*2);f=this._context;f.clearRect(a*2,b*2,i*2,j*2);f.drawImage(e._buffer,
0,0,i*2,j*2,a*2,b*2,i*2,j*2)}else{f.clearRect(0,0,i,j);f.drawImage(this._context.canvas,g,q,i,j,0,0,i,j);f=this._context;f.clearRect(a,b,i,j);f.drawImage(e._buffer,0,0,i,j,a,b,i,j)}a==0?this.redraw(i,0,e.width-i,e.height):this.redraw(0,0,e.width-i,e.height);b==0?this.redraw(0,j,e.width,e.height-j):this.redraw(0,0,e.width,e.height-j)}else this.redraw(0,0,e.width,e.height)}else this.redraw(0,0,e.width,e.height);this._previousOffsetX=this._offsetX;this._previousOffsetY=this._offsetY})},loadData:function(a){this._data=
Array.prototype.slice.apply(arguments);this._dirty=true;this._tight=false;for(var b=0,d=this._data.length;b<d;b++){for(var c=0,a=this._data[b],e=0,h=a.length;e<h;e++)for(var k=0,f=a[e].length;k<f;k++)a[e][k]>=0&&c++;if(c/(a.length*a[0].length)>0.2){this._tight=true;break}}},hitTest:function(a,b){if(a<0||this.width<=a||b<0||this.height<=b)return false;var d=this._image.width,c=this._image.height,e=this._tileWidth||d,h=this._tileHeight||c,a=a/e|0,b=b/h|0;if(this.collisionData!=null)return this.collisionData[b]&&
!!this.collisionData[b][a];for(var k=0,f=this._data.length;k<f;k++){var i=this._data[k],j;if(i[b]!=null&&(j=i[b][a])!=null&&0<=j&&j<(d/e|0)*(c/h|0))return true}return false},image:{get:function(){return this._image},set:function(a){this._image=a;if(enchant.ENV.RETINA_DISPLAY&&e.scale==2){for(var b=new enchant.Surface(a.width*2,a.height*2),d=this._tileWidth||a.width,c=this._tileHeight||a.height,p=a.width/d|0,h=a.height/c|0,k=0;k<h;k++)for(var f=0;f<p;f++)b.draw(a,f*d,k*c,d,c,f*d*2,k*c*2,d*2,c*2);this._doubledImage=
b}this._dirty=true}},tileWidth:{get:function(){return this._tileWidth},set:function(a){this._tileWidth=a;this._dirty=true}},tileHeight:{get:function(){return this._tileHeight},set:function(a){this._tileHeight=a;this._dirty=true}},width:{get:function(){return this._tileWidth*this._data[0][0].length}},height:{get:function(){return this._tileHeight*this._data[0].length}},redraw:function(a,b,d,c){if(this._image!=null){var e,h,f,g,i;if(this._doubledImage){e=this._doubledImage;h=this._tileWidth*2;f=this._tileHeight*
2;g=-this._offsetX*2;i=-this._offsetY*2;a=a*2;b=b*2;d=d*2;c=c*2}else{e=this._image;h=this._tileWidth;f=this._tileHeight;g=-this._offsetX;i=-this._offsetY}var j=e.width/h|0,l=e.height/f|0,m=Math.max((a+g)/h|0,0),n=Math.max((b+i)/f|0,0),o=Math.ceil((a+g+d)/h),r=Math.ceil((b+i+c)/f);e=e._element;var v=this._context;v.clearRect(a,b,d,c);d=0;for(c=this._data.length;d<c;d++)for(var t=this._data[d],u=Math.min(o,t[0].length),x=Math.min(r,t.length),b=n;b<x;b++)for(a=m;a<u;a++){var s=t[b][a];0<=s&&s<j*l&&v.drawImage(e,
s%j*h,(s/j|0)*f,h,f,a*h-g,b*f-i,h,f)}}}});enchant.Group=enchant.Class.create(enchant.Node,{initialize:function(){enchant.Node.call(this);this.childNodes=[];this._y=this._x=0},addChild:function(a){this.childNodes.push(a);a.parentNode=this;a.dispatchEvent(new enchant.Event("added"));if(this.scene){var b=new enchant.Event("addedtoscene");a.scene=this.scene;a.dispatchEvent(b);a._updateCoordinate();var d=document.createDocumentFragment(),c,e=Array.prototype.push;if(a._element)d.appendChild(a._element);
...
insertBefore:function(a,b){var d=this.childNodes.indexOf(b);if(d!=-1){this.childNodes.splice(d,0,a);a.parentNode=this;a.dispatchEvent(new enchant.Event("added"));if(this.scene){var c=new enchant.Event("addedtoscene");a.scene=this.scene;a.dispatchEvent(c);a._updateCoordinate();var e=document.createDocumentFragment(),f,k=Array.prototype.push;if(a._element)e.appendChild(a._element);else if(a.childNodes)for(f=a.childNodes.slice().reverse();f.length;){a=f.pop();a.scene=this.scene;a.dispatchEvent(c);a._element?
e.appendChild(a._element):a.childNodes&&k.apply(f,a.childNodes.reverse())}if(e.childNodes.length){for(var g,c=b;c!=this;){if(d!=null){f=this.childNodes.slice(d+1).reverse();d=null}else{f=c.parentNode.childNodes;f=f.slice(f.indexOf(c)+1).reverse()}for(;f.length;){a=f.pop();if(a._element){g=a._element;break}else a.childNodes&&k.apply(f,a.childNodes.slice().reverse())}c=c.parentNode}g?this.scene._element.insertBefore(e,g):this.scene._element.appendChild(e)}}}else this.addChild(a)},removeChild:function(a){var b=
...
g.src);};g.addEventListener("canplaythrough",function(){c.duration=g.duration;c.dispatchEvent(new enchant.Event("load"))},false);c._element=g}else if(b=="audio/mpeg"){var h=document.createElement("embed"),d="enchant-audio"+e._soundID++;h.width=h.height=1;h.name=d;h.src="sound.swf?id="+d+"&src="+a;h.allowscriptaccess="always";h.style.position="absolute";h.style.left="-1px";c.addEventListener("load",function(){Object.defineProperties(h,{currentTime:{get:function(){return h.getCurrentTime()},set:function(a){h.setCurrentTime(a)}},
volume:{get:function(){return h.getVolume()},set:function(a){h.setVolume(a)}}});c._element=h;c.duration=h.getDuration()});e._element.appendChild(h);enchant.Sound[d]=c}else window.setTimeout(function(){c.dispatchEvent(new enchant.Event("load"))},0);return c};window.addEventListener("message",function(a){try{var b=JSON.parse(a.data);if(b.type=="event")enchant.Game.instance.dispatchEvent(new Event(b.value));else if(b.type=="debug")switch(b.value){case "start":enchant.Game.instance.start();break;case "pause":enchant.Game.instance.pause();
