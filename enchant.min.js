...
document.head.appendChild(a));a.setAttribute("content","width=640px");return!0}return!1}(),c;enchant.Class=function(a,b){return enchant.Class.create(a,b)};enchant.Class.create=function(a,b){if(0==arguments.length)return enchant.Class.create(Object,b);if(1==arguments.length&&"function"!=typeof arguments[0])return enchant.Class.create(Object,arguments[0]);for(var e in b)b.hasOwnProperty(e)&&(Object.getPrototypeOf(b[e])==Object.prototype?"enumerable"in b[e]||(b[e].enumerable=!0):b[e]={value:b[e],enumerable:!0,
...
(this.width-i)/2;d.y=(this.height-o)/2;var j=new enchant.Surface(i,o);j.context.fillStyle="#fff";j.context.fillRect(0,0,i,o);j.context.fillStyle="#000";j.context.fillRect(k,k,i-2*k,o-2*k);d.image=j;var g=0,f=0;this.addEventListener("progress",function(a){g=a.loaded/a.total});d.addEventListener("enterframe",function(){f*=0.9;f+=0.1*g;j.context.fillStyle="#fff";j.context.fillRect(k,0,(i-2*k)*f,o)});this.loadingScene.addChild(d);this._soundID=this._surfaceID=this._mousedownID=0;this._intervalID=null;
this.input={};this._keybind={};this.keybind(37,"left");this.keybind(38,"up");this.keybind(39,"right");this.keybind(40,"down");var n=0;"left,right,up,down,a,b".split(",").forEach(function(a){this.addEventListener(a+"buttondown",function(b){this.input[a]||(this.input[a]=!0,this.dispatchEvent(new enchant.Event(n++?"inputchange":"inputstart")));this.currentScene.dispatchEvent(b)});this.addEventListener(a+"buttonup",function(b){this.input[a]&&(this.input[a]=!1,this.dispatchEvent(new enchant.Event(--n?
