...
this._tight=this._dirty=false;this.collisionData=null;this._listeners.render=null;this.addEventListener("render",function(){this._offsetX=~~this._offsetX;this._offsetY=~~this._offsetY;if(this._dirty||this._previousOffsetX==null){this._dirty=false;this.redraw(0,0,c.width,c.height)}else if(this._offsetX!=this._previousOffsetX||this._offsetY!=this._previousOffsetY)if(this._tight){var a=-this._offsetX,b=-this._offsetY,e=-this._previousOffsetX,h=-this._previousOffsetY,p=a-e+c.width,j=e-a+c.width,k=b-h+
c.height,f=h-b+c.height;if(p>this._tileWidth&&j>this._tileWidth&&k>this._tileHeight&&f>this._tileHeight){var i;if(p<j){i=0;a=e-a;j=p}else{i=a-e;a=0}if(k<f){p=0;b=h-b}else{p=b-h;b=0;k=f}if(c._buffer==null){c._buffer=document.createElement("canvas");c._buffer.width=this._context.canvas.width;c._buffer.height=this._context.canvas.height}f=c._buffer.getContext("2d");if(this._doubledImage){f.clearRect(0,0,j*2,k*2);f.drawImage(this._context.canvas,i*2,p*2,j*2,k*2,0,0,j*2,k*2);f=this._context;f.clearRect(a*
2,b*2,j*2,k*2);f.drawImage(c._buffer,0,0,j*2,k*2,a*2,b*2,j*2,k*2)}else{f.clearRect(0,0,j,k);f.drawImage(this._context.canvas,i,p,j,k,0,0,j,k);f=this._context;f.clearRect(a,b,j,k);f.drawImage(c._buffer,0,0,j,k,a,b,j,k)}a==0?this.redraw(j,0,c.width-j,c.height):this.redraw(0,0,c.width-j,c.height);b==0?this.redraw(0,k,c.width,c.height-k):this.redraw(0,0,c.width,c.height-k)}else this.redraw(0,0,c.width,c.height)}else this.redraw(0,0,c.width,c.height);this._previousOffsetX=this._offsetX;this._previousOffsetY=
this._offsetY})},loadData:function(a){this._data=Array.prototype.slice.apply(arguments);this._dirty=true;this._tight=false;for(var b=0,e=this._data.length;b<e;b++){for(var d=0,a=this._data[b],c=0,g=a.length;c<g;c++)for(var h=0,f=a[c].length;h<f;h++)a[c][h]>=0&&d++;if(d/(a.length*a[0].length)>0.2){this._tight=true;break}}},hitTest:function(a,b){if(a<0||this.width<=a||b<0||this.height<=b)return false;var e=this._image.width,d=this._image.height,c=this._tileWidth||e,g=this._tileHeight||d,a=a/c|0,b=b/
g|0;if(this.collisionData!=null)return this.collisionData[b]&&!!this.collisionData[b][a];for(var h=0,f=this._data.length;h<f;h++){var j=this._data[h],k;if(j[b]!=null&&(k=j[b][a])!=null&&0<=k&&k<(e/c|0)*(d/g|0))return true}return false},image:{get:function(){return this._image},set:function(a){this._image=a;if(o&&c.scale==2){for(var b=new enchant.Surface(a.width*2,a.height*2),e=this._tileWidth||a.width,d=this._tileHeight||a.height,l=a.width/e|0,g=a.height/d|0,h=0;h<g;h++)for(var f=0;f<l;f++)b.draw(a,
f*e,h*d,e,d,f*e*2,h*d*2,e*2,d*2);this._doubledImage=b}this._dirty=true}},tileWidth:{get:function(){return this._tileWidth},set:function(a){this._tileWidth=a;this._dirty=true}},tileHeight:{get:function(){return this._tileHeight},set:function(a){this._tileHeight=a;this._dirty=true}},width:{get:function(){return this._tileWidth*this._data[0][0].length}},height:{get:function(){return this._tileHeight*this._data[0].length}},redraw:function(a,b,e,d){if(this._image!=null){var c,g,f,i,j;if(this._doubledImage){c=
this._doubledImage;g=this._tileWidth*2;f=this._tileHeight*2;i=-this._offsetX*2;j=-this._offsetY*2;a=a*2;b=b*2;e=e*2;d=d*2}else{c=this._image;g=this._tileWidth;f=this._tileHeight;i=-this._offsetX;j=-this._offsetY}var k=c.width/g|0,m=c.height/f|0,n=Math.max((a+i)/g|0,0),o=Math.max((b+j)/f|0,0),q=Math.ceil((a+i+e)/g),s=Math.ceil((b+j+d)/f);c=c._element;var u=this._context;u.clearRect(a,b,e,d);e=0;for(d=this._data.length;e<d;e++)for(var t=this._data[e],v=Math.min(q,t[0].length),w=Math.min(s,t.length),
...
d.apply(c,a.childNodes)}}}},firstChild:{get:function(){return this.childNodes[0]}},lastChild:{get:function(){return this.childNodes[this.childNodes.length-1]}},_updateCoordinate:function(){if(this.parentNode){this._offsetX=this.parentNode._offsetX+this._x;this._offsetY=this.parentNode._offsetY+this._y}else{this._offsetX=this._x;this._offsetY=this._y}for(var a=0,b=this.childNodes.length;a<b;a++)this.childNodes[a]._updateCoordinate()}});enchant.Scene=enchant.Class.create(enchant.Group,{initialize:function(){enchant.Group.call(this);
this._element=document.createElement("div");this._element.style.position="absolute";this._element.style.overflow="hidden";this._element.style.width=(this.width=c.width)+"px";this._element.style.height=(this.height=c.height)+"px";this._element.style[i+"TransformOrigin"]="0 0";this._element.style[i+"Transform"]="scale("+c.scale+")";this.scene=this;var a=this;if(m){this._element.addEventListener("touchstart",function(b){for(var c=b.touches,d=0,f=c.length;d<f;d++){b=new enchant.Event("touchstart");b.identifier=
...
c[d].pageY);a.dispatchEvent(b)}},false)}else{this._element.addEventListener("mousedown",function(b){var e=b.pageX,d=b.pageY,b=new enchant.Event("touchstart");b.identifier=c._mousedownID;b._initPosition(e,d);a.dispatchEvent(b);a._mousedown=true},false);c._element.addEventListener("mousemove",function(b){if(a._mousedown){var e=b.pageX,d=b.pageY,b=new enchant.Event("touchmove");b.identifier=c._mousedownID;b._initPosition(e,d);a.dispatchEvent(b)}},false);c._element.addEventListener("mouseup",function(b){if(a._mousedown){var e=
b.pageX,d=b.pageY,b=new enchant.Event("touchend");b.identifier=c._mousedownID;b._initPosition(e,d);a.dispatchEvent(b);a._mousedown=false}},false)}},backgroundColor:{get:function(){return this._backgroundColor},set:function(a){this._element.style.backgroundColor=this._backgroundColor=a}},_updateCoordinate:function(){this._offsetX=this._x;this._offsetY=this._y;for(var a=0,b=this.childNodes.length;a<b;a++)this.childNodes[a]._updateCoordinate()}});var n=["putImageData","drawImage","drawFocusRing","fill",
...
return a},currentTime:{get:function(){return this._element?this._element.currentTime:0},set:function(a){if(this._element)this._element.currentTime=a}},volume:{get:function(){return this._element?this._element.volume:1},set:function(a){if(this._element)this._element.volume=a}}});enchant.Sound.load=function(a,b){if(b==null)var e=f(a),b=e?"audio/"+e:"";var b=b.replace("mp3","mpeg"),d=Object.create(enchant.Sound.prototype);enchant.EventTarget.call(d);var l=new Audio;if(!enchant.Sound.enabledInMobileSafari&&
