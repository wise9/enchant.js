...
if(d){var m=window.getComputedStyle(d),a=parseInt(m.width),b=parseInt(m.height);a&&b?this.scale=Math.min(a/this.width,b/this.height):(d.style.width=this.width+"px",d.style.height=this.height+"px");for(;d.firstChild;)d.removeChild(d.firstChild);d.style.position="relative";m=d.getBoundingClientRect();isNaN(window.scrollX);isNaN(window.scrollY);this._pageX=Math.round(window.scrollX+m.left);this._pageY=Math.round(window.scrollY+m.top)}else d=document.createElement("div"),d.id="enchant-stage",d.style.width=
window.innerWidth+"px",d.style.height=window.innerHeight+"px",d.style.position="absolute",document.body.firstChild?document.body.insertBefore(d,document.body.firstChild):document.body.appendChild(d),this.scale=Math.min(window.innerWidth/this.width,window.innerHeight/this.height),this._pageY=this._pageX=0;if(!this.scale)this.scale=1;d.style.fontSize="12px";d.style.webkitTextSizeAdjust="none";this._element=d;this.fps=30;this.frame=0;this.ready=null;this.running=!1;this.assets={};var h=this._assets=
[];(function q(a){a.assets instanceof Array&&[].push.apply(h,a.assets);for(var b in a)a.hasOwnProperty(b)&&Object.getPrototypeOf(a[b])==Object.prototype&&q(a[b])})(enchant);this._scenes=[];this.currentScene=null;this.rootScene=new enchant.Scene;this.pushScene(this.rootScene);this.loadingScene=new enchant.Scene;this.loadingScene.backgroundColor="#000";var i=0.9*this.width|0,o=0.3*this.width|0,j=0.05*i|0,d=new enchant.Sprite(i,o);d.x=(this.width-i)/2;d.y=(this.height-o)/2;var k=new enchant.Surface(i,
o);k.context.fillStyle="#fff";k.context.fillRect(0,0,i,o);k.context.fillStyle="#000";k.context.fillRect(j,j,i-2*j,o-2*j);d.image=k;var g=0,f=0;this.addEventListener("progress",function(a){g=a.loaded/a.total});d.addEventListener("enterframe",function(){f*=0.9;f+=0.1*g;k.context.fillStyle="#fff";k.context.fillRect(j,0,(i-2*j)*f,o)});this.loadingScene.addChild(d);this._soundID=this._surfaceID=this._mousedownID=0;this._intervalID=null;this.input={};this._keybind={};this.keybind(37,"left");this.keybind(38,
"up");this.keybind(39,"right");this.keybind(40,"down");var n=0;"left,right,up,down,a,b".split(",").forEach(function(a){this.addEventListener(a+"buttondown",function(b){this.input[a]||(this.input[a]=!0,this.dispatchEvent(new enchant.Event(n++?"inputchange":"inputstart")));this.currentScene.dispatchEvent(b)});this.addEventListener(a+"buttonup",function(b){this.input[a]&&(this.input[a]=!1,this.dispatchEvent(new enchant.Event(--n?"inputchange":"inputend")));this.currentScene.dispatchEvent(b)})},this);
e&&(document.addEventListener("keydown",function(a){c.dispatchEvent(new enchant.Event("keydown"));if(37<=a.keyCode&&40>=a.keyCode||32==a.keyCode)a.preventDefault(),a.stopPropagation();if(c.running&&(a=c._keybind[a.keyCode]))a=new enchant.Event(a+"buttondown"),c.dispatchEvent(a)},!0),document.addEventListener("keyup",function(a){if(c.running&&(a=c._keybind[a.keyCode]))a=new enchant.Event(a+"buttonup"),c.dispatchEvent(a)},!0),l?(document.addEventListener("touchstart",function(a){a.preventDefault()},
!0),document.addEventListener("touchmove",function(a){a.preventDefault();c.running||a.stopPropagation()},!0),document.addEventListener("touchend",function(a){a.preventDefault();c.running||a.stopPropagation()},!0)):(document.addEventListener("mousedown",function(a){a.preventDefault();c._mousedownID++;c.running||a.stopPropagation()},!0),document.addEventListener("mousemove",function(a){a.preventDefault();c.running||a.stopPropagation()},!0),document.addEventListener("mouseup",function(a){a.preventDefault();
...
a;this._updateCoordinate()}},_updateCoordinate:function(){this.parentNode?(this._offsetX=this.parentNode._offsetX+this._x,this._offsetY=this.parentNode._offsetY+this._y):(this._offsetX=this._x,this._offsetY=this._y)},remove:function(){this._listener&&this.clearEventListener();this.parentNode&&this.removeChild(this)}});enchant.Entity=enchant.Class.create(enchant.Node,{initialize:function(){enchant.Node.call(this);this._element=document.createElement("div");this._style=this._element.style;this._style.position=
"absolute";this._scaleY=this._scaleX=1;this._rotation=0;this._dirty=!1;this._transformOrigin="";this._height=this._width=0;this._backgroundColor=null;this._opacity=1;this._visible=!0;this._buttonMode=null;this.addEventListener("render",function(){if(this._dirty)this._style[g+"Transform"]=["rotate(",this._rotation,"deg)scale(",this._scaleX,",",this._scaleY,")"].join(""),this._dirty=!1});if(enchant.Game.instance._debug)this._style.border="1px solid blue",this._style.margin="-1px";this.buttonMode=null;
this.buttonPressed=!1;this.addEventListener("touchstart",function(){if(this.buttonMode){this.buttonPressed=!0;var a=new enchant.Event(this.buttonMode+"buttondown");this.dispatchEvent(a);c.dispatchEvent(a)}});this.addEventListener("touchend",function(){if(this.buttonMode){this.buttonPressed=!1;var a=new enchant.Event(this.buttonMode+"buttonup");this.dispatchEvent(a);c.dispatchEvent(a)}});var a=this,b=function(){a.dispatchEvent(new enchant.Event("render"))};this.addEventListener("addedtoscene",function(){b();
c.addEventListener("exitframe",b)});this.addEventListener("removedfromscene",function(){c.removeEventListener("exitframe",b)});this.addEventListener("render",function(){if(this._offsetX!=this._previousOffsetX)this._style.left=this._offsetX+"px";if(this._offsetY!=this._previousOffsetY)this._style.top=this._offsetY+"px";this._previousOffsetX=this._offsetX;this._previousOffsetY=this._offsetY});a=this;l?(this._element.addEventListener("touchstart",function(b){for(var d=b.touches,c=0,h=d.length;c<h;c++)b=
new enchant.Event("touchstart"),b.identifier=d[c].identifier,b._initPosition(d[c].pageX,d[c].pageY),a.dispatchEvent(b)},!1),this._element.addEventListener("touchmove",function(b){for(var d=b.touches,c=0,h=d.length;c<h;c++)b=new enchant.Event("touchmove"),b.identifier=d[c].identifier,b._initPosition(d[c].pageX,d[c].pageY),a.dispatchEvent(b)},!1),this._element.addEventListener("touchend",function(b){for(var d=b.changedTouches,c=0,h=d.length;c<h;c++)b=new enchant.Event("touchend"),b.identifier=d[c].identifier,
b._initPosition(d[c].pageX,d[c].pageY),a.dispatchEvent(b)},!1)):(this._element.addEventListener("mousedown",function(b){var d=b.pageX,m=b.pageY,b=new enchant.Event("touchstart");b.identifier=c._mousedownID;b._initPosition(d,m);a.dispatchEvent(b);a._mousedown=!0},!1),c._element.addEventListener("mousemove",function(b){if(a._mousedown){var d=b.pageX,m=b.pageY,b=new enchant.Event("touchmove");b.identifier=c._mousedownID;b._initPosition(d,m);a.dispatchEvent(b)}},!1),c._element.addEventListener("mouseup",
...
b;this._image=null;this._frame=0;this._style.overflow="hidden";if(enchant.Game.instance._debug)this._style.border="1px solid red",this._style.margin="-1px",this.addEventListener("touchstart",function(){enchant.Game.instance.running||console.log("touchstart",this)})},image:{get:function(){return this._image},set:function(a){if(a!=this._image){if(null!=this._image)if(this._image.css)this._style.backgroundImage="";else if(this._element.firstChild)this._element.removeChild(this._element.firstChild),this._dirtyListener?
(this.removeEventListener("render",this._dirtyListener),this._dirtyListener=null):this._image._parent=null;if(null!=a)if(a._css)this._style.backgroundImage=a._css;else if(a._parent){var b=document.createElement("canvas"),e=b.getContext("2d");b.width=a.width;b.height=a.height;e.drawImage(a._element,0,0);this._dirtyListener=function(){if(a._dirty)e.drawImage(a._element),a._dirty=!1};this.addEventListener("render",this._dirtyListener);this._element.appendChild(b)}else a._parent=this,this._element.appendChild(a._element);
this._image=a;this.frame=this.frame}}},frame:{get:function(){return this._frame},set:function(a){this._frame=a;if(null!=this._image){var b=this._image.width/this._width|0;if(this._image._css)this._style.backgroundPosition=[-(a%b)*this._width,"px ",-(a/b|0)*this._height,"px"].join("");else if(this._element.firstChild){var e=this._element.firstChild.style;e.left=-(a%b)*this._width+"px";e.top=-(a/b|0)*this._height+"px"}}}}});enchant.Label=enchant.Class.create(enchant.Entity,{initialize:function(a){enchant.Entity.call(this);
...
this._offsetY!=this._previousOffsetY)if(this._tight){var a=-this._offsetX,b=-this._offsetY,e=-this._previousOffsetX,i=-this._previousOffsetY,g=a-e+c.width,j=e-a+c.width,k=b-i+c.height,f=i-b+c.height;if(g>this._tileWidth&&j>this._tileWidth&&k>this._tileHeight&&f>this._tileHeight){var l;g<j?(l=0,a=e-a,j=g):(l=a-e,a=0);k<f?(g=0,b=i-b):(g=b-i,b=0,k=f);if(null==c._buffer)c._buffer=document.createElement("canvas"),c._buffer.width=this._context.canvas.width,c._buffer.height=this._context.canvas.height;f=
