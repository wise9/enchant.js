...
window.onload = function(){
    ...
    game.onload = function(){
        ...
        var label = new Label("<input type='text' placeholder='hello'><input type='button' value='button'><br><textarea placeholder='textarea'></textarea>");
        game.rootScene.addChild(label);
        var label = new Label("testtest");
        label.y = 64;
        game.rootScene.addChild(label);
    };
