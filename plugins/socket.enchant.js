// enchant よくわからないんでイベント管理周り独立して書きます。
// 時間があるときに直すか、enchantよくわかってる人がなおしてください
    ...
    lobby.onjoin = function (data) {
      ...
      if(data['playerList'].length !== 0) {
        setTimeout(function () {
          ...
          socket.timer = setTimeout(function () {socket.matching = false;}, socket.timeout);
        }, 1000);
      }
    };
